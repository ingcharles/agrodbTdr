...
<header>
	...
	<nav>
		<form id="listaCertificacionBT" data-rutaAplicacion="certificacionBrucelosisTuberculosis" data-opcion="listaCertificacionBTPlantaCentralFiltrada" data-destino="tabla">
			<table class="filtro">
				<tr>
				...
				<tr>
					...
					<td>
						<select id="bEstado" name="bEstado" required="required">
							<option value="plantaCentral">Análisis Positivos</option>
						</select>
					</td>
				</tr>
