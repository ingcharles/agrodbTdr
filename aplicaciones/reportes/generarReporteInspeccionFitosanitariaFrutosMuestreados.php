...
header("Content-Disposition: attachment; filename=REPORTE_INSPECCION_FITO_FRUTOS_MANGO.xls");
...
$res = $cr->generarReporteInspeccionFitoFrutosMuestreados($conexion, $fechaInicio, $fechaFin);
?>
...
<div id="tabla">
    <table id="tablaReporte" class="soloImpresion">
        <thead>
        <?php
        echo $cr->construirEncabezadoReporte($conexion, array('certificacionf12', 'certificacionf12_detalle_muestras'), $campos);
        ?>
        </thead>
        <tbody>
        <?php
