...
<div id="estado"></div>
	...
	<form id='nuevoEmitirCertificado' data-rutaAplicacion='fitosanitarioExportacion' data-opcion='guardarNuevoEmisionEphyto' data-destino="detalleItem" data-accionEnExito="ACTUALIZAR">
	<fieldset>
