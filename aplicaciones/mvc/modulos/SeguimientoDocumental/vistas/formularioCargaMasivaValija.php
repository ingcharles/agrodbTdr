...
<form id='formulario'
	data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>SeguimientoDocumental' data-opcion='valijas/cargarDocumentoMasivo' data-destino="detalleItem" method="post">
	...
	<fieldset>
		...
		<div data-linea="1">
			...
			<button type="button" class="subirArchivo adjunto" data-rutaCarga="aplicaciones/mvc/modulos/SeguimientoDocumental/archivos/valijas">Subir archivo</button>
		</div>
