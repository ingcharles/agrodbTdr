...
<form id="guardarCitaMedica"
	...
	data-opcion="guardarCitaMedica" data-accionEnExito="ACTUALIZAR">
	...
	<fieldset>
		...
		<div data-linea="4">
			<label>* Dirección de Atención Médica:</label> <input type="text"
				id="direccionMedico" name="direccionMedico" value="" maxlength="64"/>
		</div>
		<div data-linea="5">
...
var solicitud =<?php echo json_encode($solicitud); ?>;
	...
	$('button.subirArchivo').click(function (event) {	
        ...
        if (extension[extension.length - 1].toUpperCase() == 'PDF') {
        		...
        		subirArchivo(
    	                archivo
    	                , solicitud+'_reporteAvisoAccidentes'+'_'+cedula
