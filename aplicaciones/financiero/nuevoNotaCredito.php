<?php 
	...
	$cabeceraNotaCredito = pg_fetch_assoc($cc->abrirDatosEmisor($conexion, $identificadorUsuarioRegistro));
...
<form id='nuevoNotaCredito' data-rutaAplicacion='financiero' data-opcion='guardarNuevoNotaCredito' data-destino="detalleItem">
...
$("#nuevoNotaCredito").submit(function(event){
	event.preventDefault();
	 $('#nuevoNotaCredito').attr('data-opcion','guardarNuevoNotaCredito');
