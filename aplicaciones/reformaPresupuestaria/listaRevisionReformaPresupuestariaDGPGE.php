...
<header>
	<h1>Revisión Reforma Presupuestaria Proyectos de Inversión</h1>
	...
	<nav style="width: 78%;">
		<form id="filtrarPlanificacionAnual" data-rutaAplicacion="reformaPresupuestaria" data-opcion="listaRevisionReformaPresupuestariaFiltradaDGPGE" data-destino="contenedor">
...
var usuario = <?php echo json_encode($usuario); ?>;
	...
	$("#areaN2").change(function (event) {
	    ...
	    $("#opcion").val('n4FiltroRevisionDGPGE');

	    abrir($("#filtrarPlanificacionAnual"), event, false); //Se ejecuta ajax
	});

	$("#filtrarPlanificacionAnual").submit(function(event){
		$("#filtrarPlanificacionAnual").attr('data-opcion', 'listaReformaPresupuestariaFiltradaDGPGE');
