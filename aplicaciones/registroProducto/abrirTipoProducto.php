...
?>
	...
	<table class="soloImpresion">
		<tr>
			...
			<td>
				<form id="nuevoSubTipoProducto" data-rutaAplicacion="registroProducto" data-opcion="guardarNuevoSubtipoProducto" >
					<input type="hidden" id="idTipoProducto" name="idTipoProducto" value="<?php echo $idTipoProducto;?>">
					...
					<table id="subTipoProducto">
						<?php 
							while ($subtipoProducto = pg_fetch_assoc($subtipoProductos)){
								echo $cr->imprimirLineaSubtipoProducto($subtipoProducto['id_subtipo_producto'], $subtipoProducto['nombre'], $idTipoProducto, $tipoProducto['id_area'], 'registroProducto');
							}
						?>
					</table>
				</fieldset>
