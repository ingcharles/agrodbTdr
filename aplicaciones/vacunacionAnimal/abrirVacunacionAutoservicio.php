...
$qvacuna = $vc->listaVacunacionAnimalFiltro($conexion, $_POST['id']);
$vacuna = pg_fetch_assoc($qvacuna);

$qDetalleVacuna = $vc-> listaFiltroDetalleVacunacion($conexion,$vacuna['id_vacuna_animal']);
$qarete = $vc->listaDetalleArete ($conexion, $vacuna['id_vacuna_animal']);
...
<header>
	<h1>Registro vacunación de autoservicio</h1>
</header>
<form id='nuevoVacunacionAnimal' data-rutaAplicacion='vacunacionAnimal' data-opcion='actualizarVacunacion' data-destino="detalleItem" data-accionEnExito="ACTUALIZAR">	
	<fieldset>
		<legend>Información </legend>
			...
			<div data-linea="4">
				<label>Punto distribución</label> 
	...
	<fieldset>
		...
		<div data-linea="8">	   		
		    <textarea name="serie_arete1" rows="5" cols="100" disabled="disabled"><?php echo $var1;?></textarea>		    				
		</div>		
	</fieldset>
</form>
