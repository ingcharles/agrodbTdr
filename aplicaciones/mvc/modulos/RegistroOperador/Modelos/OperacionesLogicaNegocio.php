			...
			case 'Operadores': {
					...
					if ($resultado == 'registrado') {
						...
						if ($qOperacion->getProcesoModificacion() != 't') {
							...
							$arrayVerificarOperaciones = array(
								'identificador_operador' => $identificadorOperador, 'id_tipo_operacion' => $idTipoOperacion, 'id_area' => $idArea, 'estado' => 'porCaducar', 'id_vigencia_documento' => $idVigenciaDocumento
							);

							$qExistenciaOperacion = $this->verificarExistenciaOperaciones($arrayVerificarOperaciones);

							$arrayParametros = array(
								'id_operador_tipo_operacion' => $idOperadorTipoOperacion, 'id_historial_operacion' => $idHistorialOperacion, 'valor_vigencia' => $valorVigencia, 'tipo_tiempo_vigencia' => $tipoTiempoVigencia, 'id_vigencia_documento' => $idVigenciaDocumento
							);
							...
							if (!isset($qExistenciaOperacion->current->id_operacion)) {
								...
								$arrayParametrosOperacionExistente = array(
									'id_operador_tipo_operacion' => $qExistenciaOperacion->current()->id_operador_tipo_operacion, 'id_historial_operacion' => $qExistenciaOperacion->current()->id_historial_operacion, 'id_vigencia_documento' => $idVigenciaDocumento, 'valor_vigencia' => $valorVigencia, 'tipo_tiempo_vigencia' => $tipoTiempoVigencia, 'id_vigencia_documento' => $idVigenciaDocumento
								);
								...
								$arrayParametrosOperacionActualizar = array(
									'id_operador_tipo_operacion' => $qExistenciaOperacion->current()->id_operador_tipo_operacion, 'id_historial_operacion' => $qExistenciaOperacion->current()->id_historial_operacion, 'estado' => 'noHabilitado', 'observacion' => 'Cambio de estado no habilitado por registro de nueva operación ' . $fechaActual, 'id_vigencia_documento' => $idVigenciaDocumento
								);
						...
						switch ($estado->current()->estado) {
							...
							case 'registrado':
								...
								$arrayParametros = array(
									'id_operador_tipo_operacion' => $idOperadorTipoOperacion, 'id_historial_operacion' => $idHistorialOperacion, 'estado' => $estado->current()->estado, 'observacion' => 'Solicitud aprobada ' . $fechaActual, 'id_vigencia_documento' => $idVigenciaDocumento, 'actualizar_certificado' => 'SI', 'proceso_modificacion' => ''
								);
						...
						$arrayParametros = array(
							'id_operador_tipo_operacion' => $idOperadorTipoOperacion, 'id_historial_operacion' => $idHistorialOperacion, 'id_vigencia_documento' => $idVigenciaDocumento
						);

						$this->actualizarEstadoAnteriorPorOperadorTipoOperacionHistorial($arrayParametros);

						$arrayParametrosOperacionActualizar = array(
							'id_operador_tipo_operacion' => $idOperadorTipoOperacion, 'id_historial_operacion' => $idHistorialOperacion, 'estado' => $resultado, 'observacion' => $resultadoInspeccion['observacion_revision'], 'id_vigencia_documento' => ''
						);
