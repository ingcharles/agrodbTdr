...
/**
 * AutorizacionComprobantesOfflineService class
 * 
 *  
 * 
 * @author    {author}
 ...
 * @package   {package}
 */
class AutorizacionComprobantesOfflineService extends SoapClient {
  ...
  public function AutorizacionComprobantesOfflineService($wsdl = "https://celcer.sri.gob.ec/comprobantes-electronicos-ws/AutorizacionComprobantesOffline?wsdl", $options = array()) {
