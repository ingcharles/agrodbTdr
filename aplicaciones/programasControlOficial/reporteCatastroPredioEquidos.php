...
<header>
	...
	<nav>
		<form id="reporteCatastroPredioEquidos" data-rutaAplicacion="programasControlOficial" data-opcion="reporteCatastroPredioEquidosDetalle" data-destino="detalleItem" action="aplicaciones/programasControlOficial/reporteCatastroPredioEquidosDetalle.php" target="_blank" method="post">
			<table class="filtro">
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" id="bNombreAdministrador" name="bNombreAdministrador" />
					</td>
