...
try{
	...
	$idProductoUso = htmlspecialchars ($_POST['idProductoUso'],ENT_NOQUOTES,'UTF-8');
	...
	try {
		...
		$cr->quitarUsoProducto($conexion, $idProductoUso);
		
		$mensaje['estado'] = 'exito';
		$mensaje['mensaje'] = $idProducto.'-'.$idUso.'-'.$idAplicacion.'-'.$idProductoUso;
