<?php
 /**
 * Modelo VidasUtilesModelo
 *
 * Este archivo se complementa con el archivo   VidasUtilesLogicaNegocio.
 *
 * @author  AGROCALIDAD
 * @date    2022-07-21
 * @uses    VidasUtilesModelo
...
class VidasUtilesModelo extends ModeloBase 
{
		...
		* Campo requerido
		* Campo visible en el formulario
		* Campo que almacena el nombe de la vida util (estabilidad)
		*/
	...
	* 
	...
	/**
	* Nombre de la tabla: vidas_utiles
	* 
	 */
	Private $tabla="vidas_utiles";

	/**
	*Clave primaria
*/
		 private $clavePrimaria = "id_vida_util";
	...
	*Secuencia
*/
		 private $secuencial = 'g_modificacion_productos"."vidas_utiles_id_vida_util_seq'; 
	...
	*/
	...
	{
		throw new \Exception('Clase Modelo: VidasUtilesModelo. Propiedad especificada invalida: set'.$name);
	}
	$this->$method($value);
	}
	...
	*/
	...
	if (!method_exists($this, $method))
	{
	  throw new \Exception('Clase Modelo: VidasUtilesModelo. Propiedad especificada invalida: get'.$name);
	}
	return $this->$method();
	}
	...
	*Identificador unico de la tabla
	*
	* @parámetro Integer $idVidaUtil
	* @return IdVidaUtil
	*/
	public function setIdVidaUtil($idVidaUtil)
	{
	  $this->idVidaUtil = (Integer) $idVidaUtil;
	    return $this;
	}
	...
	* @return null|Integer
	*/
	public function getIdVidaUtil()
	{
		return $this->idVidaUtil;
	}
