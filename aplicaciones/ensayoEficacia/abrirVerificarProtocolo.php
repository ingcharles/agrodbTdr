...
<script type="text/javascript">
	...
	$("document").ready(function () {
		...
		$('#detalleItem').find('h1').first().html("Análisis del protocolo : "+protocolo.id_expediente);
		...
		if(idUsuario!=identificador){
			...
			div.append('<button id="btnAprobarProtocoloEE" type="button" class="mas guardarObservaciones">Aprobar Protocolo</button>');
		}
