...
$res=$csit->listarFiltroEnfermedadExoticaSAA($conexion,$_POST['zonaH'],$_POST['paisH'],$_POST['productoH'],$_POST['partidaH'],$_POST['estadoH'],$_POST['fechaInicioH'],$_POST['fechaFinH'],$_POST['filtro']);
...
while($fila = pg_fetch_assoc($res)){
	...
	$contenido ='<article
					...
					data-opcion="abrirEnfermedadExoticaSAA"
					...
					<aside style="padding-left: 5px;" ><small><strong>Inicio: </strong>'	.$fila['inicio_vigencia'].'<br/>
							<strong>Fin: </strong>'	.$fila['fin_vigencia'].'<br/>
...
?>
<header>
	<h1>Información de Enfermedades Exóticas Administración</h1>
	<nav>
		<a id="_nuevo" data-rutaaplicacion="serviciosInformacionTecnica" data-opcion="nuevoEnfermedadExoticaSAA" data-destino="detalleItem" href="#">Nuevo</a>
		<a id="_actualizarSubListadoItems" data-rutaaplicacion="serviciosInformacionTecnica" data-opcion="listaEnfermedadExoticaSAA" data-destino="listadoItems" href="#">Actualizar</a>
		...
		<a id="_eliminar" data-rutaaplicacion="serviciosInformacionTecnica" data-opcion="notificarEnfermedadExoticaSAA" data-destino="detalleItem" href="#">Eliminar</a>				
	</nav>
</header>

<header>
	<nav>
		<form id="nuevoRegistro" data-rutaAplicacion="serviciosInformacionTecnica" data-opcion="listaEnfermedadExoticaSAA"	data-destino="areaTrabajo #listadoItems">
			...
			<table class="filtro" style='width: 100%;'>
				<tbody>
					...
					<tr>
						...
						<td colspan="3">
							<select name="estadoH" id="estadoH" style="width: 100%">
...
<script>			
	...
	$("#nuevoRegistro").submit(function(event){
		...
		if (error){
			...
			$('#nuevoRegistro').attr('data-opcion','listaEnfermedadExoticaSAA');      	
