...
$res = $cmp->listaRolEmpleadoEmpresa($conexion, $_POST['identificacionEmpleadoH'], $_POST['nombreEmpleadoH'], $_POST['operadorMovilizacionH'], $filaTipoUsuario['codificacion_perfil'], $identificadorUsuario, 'digitadorMovilizacion');
...
while($fila = pg_fetch_assoc($res)){
	$itemsFiltrados[] = array('<tr
						...
						data-opcion="abrirRolEmpleadoMovilizacion"
...
?>
<header>
	<h1>Administrar Digitador Movilización</h1>
	<nav>
		<?php			
	...
	<nav>
	<form id="nuevoFiltroMovilizacion" data-rutaAplicacion="movilizacionProducto" data-opcion="listaRolEmpleadoMovilizacion" data-destino="areaTrabajo #listadoItems">
