...
class ControladorProgramacionPresupuestaria{
	...
	public function listarProcesoProyecto ($conexion, $idObjetivoOperativo, $anio){
		...
		$res = $conexion->ejecutarConsulta("SELECT
												pp.*, p.nombre as nombre_programa
											FROM
												g_programacion_presupuestaria.proceso_proyecto pp
												INNER JOIN g_programacion_presupuestaria.programas p ON pp.id_programa = p.id_programa
											WHERE
	...
	public function imprimirLineaProcesoProyecto($idProcesoProyecto, $nombreProcesoProyecto, $tipo, $financiamiento, $codigoPrograma, $nombrePrograma, $nombreArea, $idObjetivoEstrategico, $idObjetivoEspecifico, $idObjetivoOperativo, $areaObjetivoOperativo, $anio, $ruta){
	...
	public function modificarPresupuesto ($conexion, $idPresupuesto, $idUnidadEjecutora, $unidadEjecutora,
										...
										$detalleGasto, $idUnidadMedida, $unidadMedida, 
	...
	//APROBADORES PLANIFICACION ANUAL
	public function listarProgramacionAnualTotalVistaAprobacion ($conexion, $anio, $identificadorAprobador, $estado){
	...
	public function listarProgramacionAnualVistaTotalAprobacionDGAF ($conexion, $anio, $estado){
