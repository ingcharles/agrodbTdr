...
$res = $cci->generarReporteInspeccionMoluscosPlagaFincas($conexion,$incluirDatosLaboratorio, $fechaInicio, $fechaFin, $identificadorUsuario, $nombreUsuario, $tipoFormulario);
