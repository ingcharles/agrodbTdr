<?php 
	...
	$patologiaTuberculosis = $cbt->abrirPatologiaTuberculosisRecertificacionBT($conexion, $idRecertificacionBT);
	//$patologiaTuberculosisConsulta = $cbt->abrirPatologiaTuberculosisRecertificacionBT($conexion, $idCertificacionBT);
...
<div class="pestania">
	...
	<h2>Aspectos Sanitarios</h2>
	<h3>III. Patologías Tuberculosis</h3>

	<form id="nuevaPatologiaTuberculosis" data-rutaAplicacion="<?php echo $ruta;?>" data-opcion="guardarPatologiaTuberculosisRecertificacion" data-destino="detalleItem">
		<input type='hidden' id='idRecertificacionBT' name='idRecertificacionBT' value="<?php echo $idRecertificacionBT;?>" />
		<input type='hidden' id='numInspeccion' name='numInspeccion' value="<?php echo $certificacionBT['num_inspeccion'];?>" />
		...
		<table id="detallePatologiaTuberculosis">
			...
			<?php 
				while ($infoPatologiaTuberculosis = pg_fetch_assoc($patologiaTuberculosis)){
					echo $cbt->imprimirLineaPatologiaTuberculosisRecertificacionBT($infoPatologiaTuberculosis['id_recertificacion_bt_patologia_tuberculosis'], 
