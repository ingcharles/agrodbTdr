...
<header>
	<h1>Solicitud de Recertificación</h1>
	<nav>
		<form id="listaRecertificacionBT" data-rutaAplicacion="certificacionBrucelosisTuberculosis" data-opcion="listaRecertificacionBTFiltrada" data-destino="tabla">
			<table class="filtro">
				<tr>
				...
				<tr>
					...
					<th>Recertificación:</th>
					<td>
						<select id="bRecertificacion" name="bRecertificacion">
							<option value="">Seleccione....</option>
