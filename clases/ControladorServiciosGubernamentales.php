...
define('USUARIO_ACCESO','1103876296');
define('URL_WEB_SERVICES_ACCESO','https://www.bsg.gob.ec/sw/STI/BSGSW08_Acceder_BSG?wsdl');
//define('URL_WEB_SERVICES_CEDULA_IDENTIFICADOR','https://www.bsg.gob.ec/sw/RC/BSGSW01_Consultar_Cedula?wsdl');
define('URL_WEB_SERVICES_CEDULA_IDENTIFICADOR','https://www.bsg.gob.ec/sw/RC/BSGSW03_Consultar_Ciudadano?wsdl');
define('URL_WEB_SERVICES_SRI_IDENTIFICADOR','https://www.bsg.gob.ec/sw/SRI/BSGSW01_Consultar_RucSRI?wsdl');
define('URL_WEB_SERVICES_SENECYT','https://www.bsg.gob.ec/sw/SENESCYT/BSGSW04_Consultar_Titulos?wsdl');
define('URL_WEB_SERVICES_ANT','https://www.bsg.gob.ec/sw/ANT/BSGSW01_Consultar_MatriculaLic?wsdl');

class ControladorServiciosGubernamentales{
	...
	public function consultarWebServicesAutenticacion($urlWebService){
		...
		$servicioAutorizacion = URL_WEB_SERVICES_ACCESO;
	
		$par = array(); //TODO: Ver que es este parametro
	
		$parametrosAcceso = array();
	
		$parametrosAcceso["Cedula"] = USUARIO_ACCESO;// cedula de acceso
		$parametrosAcceso["Urlsw"] = $urlWebService;
	
		$parametrosSeguridad["ValidarPermisoPeticion"] = $parametrosAcceso;
	
		$clienteWbServicesSeguridad = new SoapClient(URL_WEB_SERVICES_ACCESO, $par);
		$error = 0;
	...
	public function consultarWebServicesCedula($cabeceraSeguridad, $identificadorConsulta){
		...
		$client = new SoapClient(URL_WEB_SERVICES_CEDULA_IDENTIFICADOR, $par);
	...
	public function consultarWebServicesRUC($cabeceraSeguridad, $identificadorConsulta, $tipoConsulta){
		...
		$client = new SoapClient(URL_WEB_SERVICES_SRI_IDENTIFICADOR, $par);
	...
	public function consultarWebServicesSenecyt($cabeceraSeguridad, $identificadorConsulta){
		...
		$par = array();
		$client = new SoapClient(URL_WEB_SERVICES_SENECYT, $par);
	...
	public function consultarWebServicesANT($cabeceraSeguridad, $identificadorConsulta){
		...
		$client = new SoapClient(URL_WEB_SERVICES_ANT, $par);
		
		$parametrosConsulta = array();
		$parametrosConsulta['Placa'] = $identificadorConsulta;
		$parametrosConsulta['Canal'] = '1';
		$parametrosConsulta['Usuario'] = 'AGROCALIDAD';
