...
<body>
	...
	<div id="estado"></div>
	<form id="regresar" data-rutaAplicacion="registroProducto" data-opcion="abrirSubtipoProducto" data-destino="detalleItem">
		...
		<button class="regresar">Regresar a Subtipo de Producto</button>
			...
			<form id="actualizarProducto" data-rutaAplicacion="registroProducto" data-opcion="modificarProducto" >
				...
				<fieldset>
			 		<legend>Producto</legend>
						...
						<div data-linea="1">
							...
							<input id="nombreProducto" name="nombreProducto" type="text" value="<?php echo $producto['nombre_comun'];?>" disabled="disabled"/>	
						</div>
						<div data-linea="1">
						...
						<label>Fecha de registro</label>
							<input type="text"	id="fecha_registro" name="fecha_registro"	value="<?php echo date('j/n/Y',strtotime($productoInocuidad['fecha_registro']));?>" disabled="disabled" />
						</div>
						<div data-linea="4">
						...
						<div data-linea="8" id="res_cliente">
							...
							<input type="hidden" id="razonSocial" name="razonSocial" value= "<?php echo $operador['nombre_operador']?>" required="required" readonly="readonly" disabled="disabled"/>
						</div>	
						
						<div data-linea="9">
							<label for="observacion">Observaciones/Modificaciones:</label>
							<input name="observacion" id="observacion" type="text" maxlength="1000" value="<?php echo $productoInocuidad['observacion'];?>" disabled="disabled" required="required"/>
						</div>
						<div data-linea="10">
			...
			<fieldset>
			 <legend>Caracteristicas</legend>
						...
						<div data-linea="4">
							...
							<input id="periodoReingreso" name="periodoReingreso" required="required" value="<?php echo $productoInocuidad['periodo_reingreso'];?>" disabled="disabled"/>
						</div>
	...
	<div class="pestania" id="ParteVII">
			...
			<div data-linea="32">
				<form id='certificadoProductosInocuidad' data-rutaAplicacion='registroProducto' method="post">
					...
					<div style="text-align: center;">        			
							<button id="botonCertificado" type="submit">Generar certificado de producto</button>
					</div>
  ...
  $('#idTipoComponente').change(function(){
	...
	$("#actualizarProducto").submit(function(event){
		...
		if (error){
			...
			$("#actualizarProducto").attr('data-opcion','abrirProducto');
