...
$ext   = '.xls';
$nomReporte = "REPORTE_VACUNACION_USUARIOS_INTERNOS_".$fecha.$ext;
...
$res = $va->imprimirReporteVacunacionUsuarioInterno($conexion, $distribuidor,$vacunador,$provincia, $fechaInicio, $fechaFin, $estado);
?>
<html LANG="es">
<head>
<meta http-equiv="Content-Type" content="text/html;charset=utf-8">
<style type="text/css">
#tablaReporteVacunacionUsuarioInterno{
...
#tablaReporteVacunacionUsuarioInterno td, #tablaReporteVacunacionUsuarioInterno th {
font-size:1em;
border:1px solid #98bf21;
padding:3px 7px 2px 7px;
}

#tablaReporteVacunacionUsuarioInterno th {
font-size:1em;
text-align:left;
padding-top:5px;
padding-bottom:4px;
...
<div id="tabla">
<table id="tablaReporteVacunacionUsuarioInterno" class="soloImpresion">
	<thead>
		<tr>
