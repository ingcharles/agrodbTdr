...
<header>
	<h1>Reporte de Certificación de Predios Libres de Brucelosis y Tuberculosis</h1>
	<nav>
		<form id="listaRecertificacionBT" data-rutaAplicacion="certificacionBrucelosisTuberculosis" data-opcion="reporteCertificacionBTDetalle" data-destino="detalleItem" action="aplicaciones/certificacionBrucelosisTuberculosis/reporteCertificacionBTDetalle.php" target="_blank" method="post">
