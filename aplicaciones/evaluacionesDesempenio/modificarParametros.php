...
try{
		$datos = array(
				...
				'codParametro' => htmlspecialchars ($_POST['codParametro'],ENT_NOQUOTES,'UTF-8'));
	try {
		$conexion = new Conexion();
		$ced = new ControladorEvaluacionesDesempenio();

		$conexion->ejecutarConsulta("begin;");
		$qEvaluacion = $ced->modificarParametros($conexion,$_POST['codParametro'], $datos['nombreParametro'], $datos['anio'],$datos['periodo'],$datos['semestre'],$datos['numDias'],$datos['fechaInicio'],$datos['fechaFin'],$datos['evaluacionArea'],$datos['calculoResultado'],$datos['envioNotificacion'],$datos['notificacion']);
		$ced->registroModificaciones($conexion,$_SESSION['usuario'],$datos['codParametro'],'parametros');
		$conexion->ejecutarConsulta("commit;");
		$mensaje['estado'] = 'exito';
		$mensaje['mensaje'] = 'Parámetros actualizados satisfactoriamente.';
