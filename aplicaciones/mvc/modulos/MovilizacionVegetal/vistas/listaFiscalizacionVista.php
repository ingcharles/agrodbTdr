...
<script>
	...
	function fn_filtrar() {
		...
		if(!$.trim($("#tipoBusqueda").val())){
        	error = true;
    		$("#tipoBusqueda").addClass("alertaCombo");
		}
		        
		if (!error) {
			$("#paginacion").html("<div id='cargando'>Cargando...</div>");
			  $.post("<?php echo URL ?>MovilizacionVegetal/Fiscalizacion/listarMovilizacionesFiscalizacionFiltradas",
		    	{
