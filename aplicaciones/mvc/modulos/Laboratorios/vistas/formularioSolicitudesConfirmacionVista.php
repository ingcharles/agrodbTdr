...
<form id='formulario' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>Laboratorios'
      data-opcion='Solicitudes/guardarConfirmacionAnalisis' data-destino="detalleItem"
    ...
    <fieldset>
        ...
        <div class="pestania" id="div_paso1">
            ...
            <fieldset>
                ...
                <div data-linea="6">
                    ...
                    <!-- Numero de muestras segun lo seleccionado para la confirmacion de analisis -->
        ...
        <div data-linea="21">
            ...
            <input type="hidden" name="muestrasConfirmar" id="muestrasConfirmar" 
            ...
            if ($(".numeroPestania:visible").text() === "Paso 4 de 4") {
                if (fn_validarAnexosSubidos() === 1) {
                    ...
                    if (!error) {
                        ...
                        {
                            fn_filtrar();   //llama a la funcion de la vista actual listaBandejaRTConfirmacionVista
                        }
                    } else {
