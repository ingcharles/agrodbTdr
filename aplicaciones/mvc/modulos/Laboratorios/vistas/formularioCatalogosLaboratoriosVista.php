...
<form id = 'formulario' data-rutaAplicacion = '<?php echo URL_MVC_FOLDER; ?>Laboratorios'			
      data-opcion = 'CatalogosLaboratorios/guardar' data-destino ="detalleItem" data-accionEnExito ="NADA" method="post">
    <fieldset><legend>Catalogos</legend>
        ...
        <div data-linea ="4">
            <?php echo $this->crearRadioEstadoAI($this->modeloCatalogos->getEstado()); ?>
        </div>
        <div data-linea ="5">			
