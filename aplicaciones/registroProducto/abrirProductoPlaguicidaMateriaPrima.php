...
<body>
	<header>
		<h1>Detalle de Producto Plaguicida Materia Prima</h1>
	</header>
	...
	<div class="pestania" id="ParteI">	
		...
		<form id="actualizarProducto" data-rutaAplicacion="registroProducto" data-opcion="modificarProductoPlaguicidaMateriaPrima" >
			...
			<fieldset>
		 		<legend>Producto</legend>
					...
					<div data-linea="4" id="res_cliente">
						...
						<input type="text" id="razonSocial" name="razonSocial" value= "<?php echo $operador['nombre_operador']?>"  readonly="readonly" disabled="disabled"/>
			...
			<fieldset>
				<legend>Características</legend>
					...
					<div data-linea="11">
						...
						<input name="estabilidad" id="estabilidad" type="text" value="<?php echo $productoInocuidad['estabilidad'];?>" disabled="disabled" />
					</div>
	...
	$("#actualizarProducto").submit(function(event){
		...
		if (error){
			...
			if(respuesta.estado == 'exito'){
    			...
    			$("#actualizarProducto").attr('data-opcion','abrirProductoPlaguicidaMateriaPrima');
