...
try{
	...
	$idCombustible = htmlspecialchars ($_POST['idCombustible'],ENT_NOQUOTES,'UTF-8');	
	...
	try {
		...
		if ($identificadorUsuarioRegistro != ''){			
			$cv->darBajaCombustible($conexion, $idCombustible, $usuarioSolicitante, $glpi, $identificadorUsuarioRegistro);
