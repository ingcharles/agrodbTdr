								...
								<select id=codigoProyecto name="codigoProyecto" required="required" disabled="disabled">
									...
									<?php 
										...
										while($fila = pg_fetch_assoc($codigoProyecto)){
										    echo '<option value="' . $fila['id_codigo_proyecto'] . '" data-codigo="'. $fila['codigo_proyecto'] .'">' . $fila['codigo_proyecto'].'-'.$fila['nombre'].' </option>';
										}
									?>
								</select>
								
								<input type='hidden' id='idCodigoProyecto' name='idCodigoProyecto' value="<?php echo $componente['id_codigo_proyecto']?>" />
								<input type='hidden' id='nombreCodigoProyecto' name='nombreCodigoProyecto' value="<?php echo $componente['codigo_proyecto']?>" />
								<input type='hidden' id='codigoCodigoProyecto' name='codigoCodigoProyecto' value="<?php echo $componente['codigo_proyecto']?>" />
						</div>
