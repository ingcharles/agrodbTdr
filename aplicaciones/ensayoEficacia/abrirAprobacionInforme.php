...
<fieldset id="cuadroAprobaciones">
	...
	<div id="divEnviar" hidden="hidden">
		...
		<label>
			<input type="radio" name="opcionAprobar" value="" />Continuar flujo del informe
		</label>
		<br />
...
<script type="text/javascript">
	...
	$("document").ready(function () {
		...
		$('#detalleItem').find('h1').first().html("Aprobar informe final : "+solicitud.id_expediente);
	...
	$(".guardarObservaciones").click(function (event) {
		...
		var param={opcion_llamada:'guardarAprobacionesInforme',
			id_flujo:id_flujo,
