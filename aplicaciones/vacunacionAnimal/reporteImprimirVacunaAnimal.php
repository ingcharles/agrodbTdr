...
$identificadorEmpresa = htmlspecialchars ($_POST['operadoraVacunacion'],ENT_NOQUOTES,'UTF-8');
...
$res = $vdr->listaReporteVacunacionAnimal($conexion, $identificadorEmpresa,$identificadorDistribuidor,$identificadorVacunador,$provincia, $fechaInicio, $fechaFin, $estado);
