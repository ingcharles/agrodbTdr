<?php 
	...
	header("Content-Disposition: attachment; filename=REPORTEXITEM.xls");
	...
	$res = $cc -> filtrarRecaudacionPorItem($conexion, $comprobante, $fechaInicio, $fechaFin, $provincia, $ruc);
