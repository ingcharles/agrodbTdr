...
class Constantes {
	...
	const RUTA_DOMINIO = 'http://localhost'; // 1 pruebas http://181.112.155.173 // 2 produccion https://guia.agrocalidad.gob.ec
	const IDENTIFICADOR_RECAUDADOR = '1722551049';//Identificador con el que se firmaran las facturas generadas por proceso automatico de saldo
