...
try{
	...
	$datos = array( 'nombreGasolinera' => htmlspecialchars ($_POST['nombreGasolinera'],ENT_NOQUOTES,'UTF-8'), 
	...
	try {
		...
		if ($identificadorUsuarioRegistro != ''){
			$cv -> guardarNuevoGasolinera($conexion, $datos['nombreGasolinera'], $datos['direccion'], $datos['cupo'], $datos['contacto'], $datos['telefono'], $datos['observaciones'], ($datos['extra']==""?0:$datos['extra']),($datos['super']==""?0:$datos['super']),($datos['diesel']==""?0:$datos['diesel']),($datos['ecopais']==""?0:$datos['ecopais']), $_SESSION['nombreLocalizacion'], $identificadorUsuarioRegistro);
