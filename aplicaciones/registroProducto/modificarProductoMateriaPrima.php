...
try{
	...
	try {
		...
		$cr->actualizarProducto ($conexion, $idProducto, $nombreProducto, $nombreCientifico, $codigoProducto,$partidaArancelaria, $archivo, $unidadMedida, $programa, $trazabilidad, $movilizacion, $identificadorModificacion, $estado);
		
		if ($idCategoriaToxicologica == 0) $idCategoriaToxicologica = 0;
		if ($idformulacion == 0) $idformulacion = 0;
		...
		$cr->actualizarProductoInocuidad($conexion, $idProducto, $idformulacion, $nombreFormulacion, $numeroRegistro, $dosis, $periodoCarencia, $periodoReingreso, $observacion, $unidadMedidaDosis, $idCategoriaToxicologica, $categoriaToxicologica, $fechaRegistro,$idDeclaracionVenta, $declaracionVenta, $empresa, $estabilidad, $razonSocial);
