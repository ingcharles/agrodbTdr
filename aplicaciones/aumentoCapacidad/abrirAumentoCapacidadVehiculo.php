...
$qDatosVehiculo = $cro->obtenerDatosVehiculoXIdArea($conexion, $idArea);
...
<form id="aumentoCapacidadVehiculo" data-rutaAplicacion="aumentoCapacidad" data-opcion="guardarAumentoCapacidadVehiculo" data-destino="detalleItem" data-accionEnExito="ACTUALIZAR">
	...
	<fieldset>
		...
		<hr/>
		<div data-linea="2">			
			<label>*Capacidad Instalada: </label><input type="text" id="capacidadInstalada" name="capacidadInstalada" value="<?php echo $datosVehiculo['capacidad_vehiculo']?>" disabled />
		</div>
		<div data-linea="2">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		distribuirLineas();		
		cargarValorDefecto("unidadMedida","<?php echo $datosVehiculo['codigo_unidad_medida']?>");
	...
	$("#aumentoCapacidadVehiculo").submit(function(event){
