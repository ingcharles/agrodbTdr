<?php
 /**
 * Modelo PeriodosReingresosModelo
 *
 * Este archivo se complementa con el archivo   PeriodosReingresosLogicaNegocio.
 *
 * @author  AGROCALIDAD
 * @date    2022-07-21
 * @uses    PeriodosReingresosModelo
...
class PeriodosReingresosModelo extends ModeloBase 
{
		...
		* Campo requerido
		* Campo visible en el formulario
		* Campo que almacena el nombe del peiodo de reingreso
		*/
	...
	* 
	...
	/**
	* Nombre de la tabla: periodos_reingresos
	* 
	 */
	Private $tabla="periodos_reingresos";

	/**
	*Clave primaria
*/
		 private $clavePrimaria = "id_periodo_reingreso";
	...
	*Secuencia
*/
		 private $secuencial = 'g_modificacion_productos"."periodos_reingresos_id_periodo_reingreso_seq'; 
	...
	*/
	...
	{
		throw new \Exception('Clase Modelo: PeriodosReingresosModelo. Propiedad especificada invalida: set'.$name);
	}
	$this->$method($value);
	}
	...
	*/
	...
	if (!method_exists($this, $method))
	{
	  throw new \Exception('Clase Modelo: PeriodosReingresosModelo. Propiedad especificada invalida: get'.$name);
	}
	return $this->$method();
	}
	...
	*/
	...
	/**
	* Set idPeriodoReingreso
	*
	*Identificador unico de la tabla
	*
	* @parámetro Integer $idPeriodoReingreso
	* @return IdPeriodoReingreso
	*/
	public function setIdPeriodoReingreso($idPeriodoReingreso)
	{
	  $this->idPeriodoReingreso = (Integer) $idPeriodoReingreso;
	    return $this;
	}

	/**
	* Get idPeriodoReingreso
	*
	* @return null|Integer
	*/
	public function getIdPeriodoReingreso()
	{
		return $this->idPeriodoReingreso;
	}
