<?php 
	...
	$presupuesto = pg_fetch_assoc($crp->abrirPresupuestoTemporal($conexion, $idPresupuesto, $anio));
...
?>
	...
	<form id="regresar" data-rutaAplicacion="reformaPresupuestaria" data-opcion="abrirReformaPlanificacionAnualRevision" data-destino="detalleItem">
	...
	<table class="soloImpresion">
		<tr>
			<td>
				...
				<div id="revision">
					<form id="revisarPresupuesto" data-rutaAplicacion="reformaPresupuestaria" data-opcion="revisarPresupuesto" data-destino="detalleItem">
...
var estadoRevision = <?php echo json_encode($estadoRevision); ?>;
	...
	$("#revisarPresupuesto").submit(function(event){
		...
		if($("#estadoRevision").val() == 'rechazado'){
