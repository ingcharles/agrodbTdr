...
$res = $ce->listaSolicitudes($conexion, "Exportacion",$solicitante,$numeroSolicitud,$fecha);
...
<header>
	<h1>Exportación</h1>
		<nav>
		<form id="filtrar" data-rutaAplicacion="mercanciasSinValorComercial" data-opcion="listaExportacion" data-destino="listadoItems">
			<input type="hidden" name="opcion" value="<?php echo $_POST['opcion']; ?>" />
				<table class="filtro" style='width: 400px;'>
					...
					<tr>
						...
						<td> <input id="solicitante" type="text" name="solicitante" maxlength="16">	</td>
					</tr>
					<tr>
						<td>* Número de Solicitud:</td>
						<td> <input id="numeroSolicitud" type="text" name="numeroSolicitud" maxlength="8">	</td>
					</tr>
					<tr>
						<td>Fecha:</td>
