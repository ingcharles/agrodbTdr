...
/**
 * This class stands for consignorSPSParty StructType
 * @subpackage Structs
 */
class ConsignorSPSParty extends AbstractStructBase
{
    /**
     * The Name
    ...
    /**
     * Constructor method for consignorSPSParty
     * @uses ConsignorSPSParty::setName()
     * @uses ConsignorSPSParty::setSpecifiedSPSAddress()
     * @param string $name
     ...
     * Set Name value
     * @param string $name
     * @return \StructType\ConsignorSPSParty
     */
