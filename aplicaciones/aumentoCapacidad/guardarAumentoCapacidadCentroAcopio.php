...
try {
	...
	try {
		...
		$verificarDatosCentroAcopio = $cro-> verificarInformacionCentroAcopio($conexion, $idArea, $idTipoOperacion, $capacidadInstalada, $codigoUnidadMedida, $idOperadorTipoOperacion);
	
		if(pg_num_rows($verificarDatosCentroAcopio) == 0){	
				
			$cro->actualizarInformacionCentroAcopio($conexion, $idArea, $idTipoOperacion, $capacidadInstalada, $codigoUnidadMedida, $idOperadorTipoOperacion);
