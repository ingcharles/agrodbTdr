...
<header>
	...
	<nav style="width: 78%;">
		<form id="filtrarPlanificacionAnual" data-rutaAplicacion="reformaPresupuestaria" data-opcion="listaReformaPresupuestariaFiltrada" data-destino="contenedor">
...
var usuario = <?php echo json_encode($usuario); ?>;
	...
	$("#filtrarPlanificacionAnual").submit(function(event){
		$("#filtrarPlanificacionAnual").attr('data-opcion', 'listaReformaPresupuestariaFiltrada');
