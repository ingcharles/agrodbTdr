...
<header>
	<h1>Control de Vectores</h1>
	<nav>
		<form id="reporteControlVectores" data-rutaAplicacion="programasControlOficial" data-opcion="reporteControlVectores" data-destino="detalleItem" action="aplicaciones/programasControlOficial/reporteControlVectoresDetalle.php" target="_blank" method="post">
