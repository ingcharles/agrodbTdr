...
<header>
	...
	<nav>
	<form id="filtrar" class="desplegar" data-rutaAplicacion="poa" data-opcion="listadoRegistrosPlantaAprobados" data-destino="tabla">
			<table class="filtro">
				<tr>
					<th>Que contenga</th>
					<td>Dirección:</td>
				...
				<tr>	
					...
					<td>
						<select name='subproceso' id='subproceso'>
							<?php 
								$res = $cpoa1->listarPOARemitidosAdministrador($conexion, $_POST['id'], '', '', '', '', 3, $fecha['year']);
