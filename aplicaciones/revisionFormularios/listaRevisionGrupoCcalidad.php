...
$itemsFiltrados[] = array();
	...
	switch ($tipoSolicitud){
		...
		case 'certificadoCalidad':
			...
			if($estado == 'pago' || $estado == 'enviado' || $estado == 'inspeccion' || $estado == 'asignadoInspeccion'){
				...
				switch ($estado){
					case 'enviado':
						$pagina = 'abrirCertificadoCalidadDocumentalGrupo';
					break;
					case 'pago':
						$pagina = 'abrirCertificadoCalidadFinancieroGrupo';
					break;
					case 'inspeccion':
						$pagina = 'abrirCertificadoCalidadInspeccionGrupo';
					break;
...
var estado = <?php echo json_encode($estado);?>;
	...
	case 'enviado':
		$('#_agrupar').attr('data-opcion','abrirCertificadoCalidadDocumental');
	break;
	...
	case 'inspeccion':
		$('#_agrupar').attr('data-opcion','abrirCertificadoCalidadInspeccionGrupo');
	break;
