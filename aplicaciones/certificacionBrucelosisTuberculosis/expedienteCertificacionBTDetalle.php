	...
	<body>
		<div id="header">
			...
			<div id="textoTitulo">Ministerio de Agricultura y Ganadería<Br>
						...
						Expediente de Certificación de Predios Libres de Brucelosis y Tuberculosis<br>
			</div>
			
			<div id="direccion"></div>
			<div id="imprimir">
				<form id="filtrar" action="expedienteCertificacionBTDetalleExcel.php" target="_blank" method="post">
