...
<header>
	<h1>Registros Proforma Aprobados</h1>
	<nav>
	<form id="filtrar" class="desplegar" data-rutaAplicacion="poa" data-opcion="listadoMPresupuestoAprobados" data-destino="tabla">
			<table class="filtro">
				<tr>
					<th>Que contenga</th>
					<td>Dirección:</td>
				...
				<tr>	
					...
					<td>
						<select name='subproceso' id='subproceso'>
							<?php 
								$res = $cpoa1->listarMatrizPresupuestosRemitidosAdministrador($conexion, $_POST['id'], '', '', '', '', 4, $fecha['year']);
								while ($fila = pg_fetch_assoc($res)){
				...
				<tr>
					...
					<td><select name="estadoRegistro" id="estadoRegistro">
						<option value="3">Aprobados coordinador</option>
