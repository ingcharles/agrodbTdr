	...
	$.ajax({
		...
		success : function(msg) {	
			$(msg.mensaje).each(function(i){
				...
				$("#plantillaImagen").html('<img alt="plantilla1" src="'+$("#cbPlantilla option:selected").attr('data-ruta')+'" width="250" height="150"></div>');
				distribuirLineas();

				$("#cbPlantilla").change(function(event){					

					$("#resultadoPlantilla").html('<div style="text-align:center;width:100%;padding-bottom: 10px;"><img alt="plantilla1" src="'+$("#cbPlantilla option:selected").attr('data-ruta')+'" width="250" height="150"></div>');
				});

				$("#btnPrevizualizar").click(function(event){
					event.preventDefault();
					
					var rutaImagen=$("#cbPlantilla option:selected").attr('data-ruta');
					var val= $("#cbEtiquetaPorHoja").val();
					var contenido="";
					switch($("#cbTamanio").val()){
						case'etiqueta':			
								contenido+='<div style="text-align:center;width:100%;padding-bottom: 10px;"><img alt="plantilla1" src="'+rutaImagen+'" width="250" height="150"></div>';			
						...
						case'A4':
							...
							$("#vizualizador").html('<div id="hoja"></div>');
    							for(i=0;i<=val-1;i++){
    								contenido+='<div style="text-align:left;width:100%;padding-bottom: 10px;"><img alt="plantilla1" src="'+rutaImagen+'" width="250" height="150"></div>';
    							}
							$("#hoja").html(contenido);	
							} else{
								...
								for(i=0;i<=val-1;i++){			
									contenido+='<div style="float:left; padding-bottom: 10px; margin-right:20px"><img alt="plantilla1" src="'+rutaImagen+'" width="250" height="150"></div>';					
								}				
