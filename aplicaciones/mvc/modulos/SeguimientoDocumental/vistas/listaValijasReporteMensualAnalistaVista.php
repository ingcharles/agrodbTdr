<header>
	<nav><?php echo $this->panelBusquedaValijasReporteAnalista;?></nav>
</header>
        ...
        <div class="modal-content">
					...
					<table id="tablaItems">
                    	<thead>
                    		<tr>
                    		    ...
                    		    <th>Destinatario</th>
                    		    <th>Clase de envío</th>
                    		    <th>Lugar de destino</th>
                    		    <th>Departamento que hace el envío</th>
                    		    <th>Persona que recibe la correspondencia</th>
            ...
            <div class="modal-footer">
            	<table>
                    	<tr>
                    		<td>
                    			<form id="filtrar" action="aplicaciones/mvc/SeguimientoDocumental/Valijas/exportarListaExcelAdministradorMensual" target="_blank" method="post">
...
<script>
	...
	function fn_filtrar() {
		...
		if (!error) {
			...
			$.post("<?php echo URL ?>SeguimientoDocumental/Reportes/mostrarReporteMensualValijas",
			    	{
