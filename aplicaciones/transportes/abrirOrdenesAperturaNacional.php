...
<header>
	...
	<h1>Orden Generada para Reapertura</h1>
</header>
...
<?php
	...
	echo   '<form id="aperturaOrdenes" data-rutaAplicacion="transportes" data-opcion="aperturaOrdenes" >
				<input type="hidden" id="identificadorUsuarioRegistro" name="identificadorUsuarioRegistro" value="'. $identificadorUsuarioRegistro .'" />
				<input type="hidden" id="numeroOrden" name="numeroOrden" value="'.$numeroOrden.'"/>
				<input type="hidden" id="tipoOrden" name="tipoOrden" value="'.$tipoOrden.'"/>
					
				<fieldset>
				<legend>Datos de Reapertura</legend>
				<div data-linea="1">
				...
				<p class="nota">La orden volverá al estado inicial de creación.</p>
				
				<button id="abrir" type="submit" class="guardar" >Abrir Orden</button>
...
?>
	...
	<script type="text/javascript">
		...
		$("#aperturaOrdenes").submit(function(event){
