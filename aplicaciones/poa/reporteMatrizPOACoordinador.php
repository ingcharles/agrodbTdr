...
//Muestra el area del coordinador
$areaCoordinador = pg_fetch_result($ca->areaUsuario($conexion, $_SESSION['usuario']), 0, 'id_area');
...
<header>
	...
	<nav>
		<form id="filtrar" action="aplicaciones/poa/reporteMPOAFiltradosCoordinador.php" target="_blank" method="post">
			<table class="filtro">
				<tr>
					<th>Que contenga</th>
					<td>Dirección:</td>
					<td><select name="areaDireccion" id="areaDireccion">
							<?php
								$qAreas = $ca->buscarAreasYSubprocesos($conexion, $areaCoordinador);
				...
				<tr>
					<th>En los</th>
					<td>Estados:</td>
					<td colspan="3"><select name="estadoReporte" id="estadoReporte">
