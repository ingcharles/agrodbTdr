...
try {
	...
	$cai->actualizarCierreCaso($conexion,$datos['solicitud'],$docUnidadIess,$docCertificadoMedico,$datos['responPatron']);
	
	///----------------finalizar solicitud----------------------------------------------------------------
	$cai->actualizarRegistroSso($conexion,$datos['solicitud'],'Subsanado','',4);
