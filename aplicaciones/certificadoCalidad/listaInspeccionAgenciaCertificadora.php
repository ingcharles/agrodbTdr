...
//Obtener usuarios por provincia de acuerdo al perfil
	...
	$estado = "'inspeccion','asignadoInspeccion'";
...
<header>
	<nav>
	<form id="listaRevision" data-rutaAplicacion="certificadoCalidad" data-opcion="listaRevisionAgenciaGrupo" data-destino="tabla">
		<table class="filtro">
			<tr>
				<th>Operador:</th>
