...
<form id='formulario'
	data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>IngresoCuvsAretes' data-opcion='IngresoCuvsAretes/cargarCuvs' data-destino="detalleItem" method="post" data-accionEnExito='ACTUALIZAR'>

	<fieldset>
		<legend>Cargar cuvs</legend>
		<div data-linea="1">
			...
			<button type="button" class="subirArchivo adjunto" data-rutaCarga="aplicaciones/mvc/modulos/IngresoCuvsAretes/archivos/cuvs">Subir archivo</button>
		</div>	
			<hr/>
		<div data-linea="2">
...
$('button.subirArchivo').click(function (event) {
	var nombre_archivo = "<?php echo 'cuvs' . (md5(time())); ?>";
        var boton = $(this);
