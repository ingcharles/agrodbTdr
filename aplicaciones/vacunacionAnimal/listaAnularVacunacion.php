...
?>
<header>
	<h1>Anular certificados de vacunación</h1>
	<nav>
		<?php
...
<header>
	<nav>
		<form id="filtrarAnularVacunacion" data-rutaAplicacion="vacunacionAnimal" data-opcion="listaAnularVacunacion" data-destino="areaTrabajo #listadoItems">
		...
		<table class="filtro" style='width: 100%;' >
			...
			<tr>
				...
				<th colspan="3"><input id="numeroCertificado" size="49%" type="text" name="numeroCertificado"></th>
			</tr>
			<tr>
				<th>Fecha inicio:</th>
	...
	<table>
		...
		<?php 			
			...
			$res = $ppc-> listaVacunacionAnulacion($conexion, $_SESSION['usuario'], $numeroCertificado, $fechaInicio, $fechaFin);
...
<script>	
	...
	$("#filtrarAnularVacunacion").submit(function(event){
		...
		if (error){
			...
			abrir($('#filtrarAnularVacunacion'),event, false); 
		}
	});
