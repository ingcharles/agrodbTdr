...
class CertificadosVacunacionModelo extends ModeloBase 
{
		...
		* Campo requerido
		* Campo visible en el formulario
		* Campo que almacena el codigo de la especie
		*/
		protected $idEspecie;
		/**
		* @var String
		* Campo requerido
		* Campo visible en el formulario
		* Campor que almacena el numero de certificado
		*/
		...
		* Campo requerido
		* Campo visible en el formulario
		* Campo que almacena la fecha en la que se modifica el estado del registro
		*/
		...
		* Campo requerido
		* Campo visible en el formulario
		* Campo que almcana la observacion
		*/
		...
		* Campo requerido
		* Campo visible en el formulario
		* Campo que almacena el identificador del usuario que utiliza el certificado
		*/
