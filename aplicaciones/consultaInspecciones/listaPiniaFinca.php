...
<h1>Piña en Finca</h1>
	<nav>
		<form action="aplicaciones/consultaInspecciones/reporteImprimirPiniaFinca.php" method="post">
			...
			<table class="filtro" style='width:100%;'>
				<tbody>
					...
					<tr>
						<td>Fecha Inicio:</td>
						<td><input id="fechaInicio" type="text" name="fechaInicio" required readonly="readonly" style='width:98%;'></td>
						<td>Fecha Fin:</td>
						<td><input id="fechaFin" type="text" name="fechaFin" required readonly="readonly" style='width:98%;' ></td>					
					</tr>
					<tr>
