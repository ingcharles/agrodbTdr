...
<header>
	...
	<nav>
		...
		<form id="nuevoFiltroCatastro" data-rutaAplicacion="catastroProducto" data-opcion="listaCatastroIndividual" data-destino="tabla">
			...
			<table class="filtro">
				...
				<tr>
					<td colspan="3" ><button type="submit" > Consultar catastro</button></td>
					<td></td>
				</tr>
				<tr>
...
$("#nuevoFiltroCatastro").submit(function(event){
	...
	if($("#identificadorSolicitanteH").val()=="" && $("#nombreOperadorSolicitante").val()=="" && $("#nombreSitio").val()=="" && $("#provincia").val()==0  ){	
		...
		$("#nombreOperadorSolicitante").addClass("alertaCombo");
