...
<div class="pestania">
	<form id='formularioClasificacion' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='solicitud/guardar' data-destino="detalleItem" method="post">
    	...
    	<fieldset>
    		...
    		<div data-linea="1">
    			...
    			<select id="id_clasificacion" name="id_clasificacion" class="formulario" required>
                    <option value="">Seleccionar....</option>
                    <?php
    		...
    		<div data-linea="2">
    			...
    			<input type="text" id="linea_biologica" name="linea_biologica" value="<?php echo $this->modeloSolicitud->getLineaBiologica(); ?>" maxlength="128"  class="formulario"/>
    		</div>
    ...
    <form id='formularioPresentacionComercial' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='PresentacionComercial/guardar' data-destino="detalleItem" method="post" class="editable">
    	...
    	<fieldset>
    		...
    		<div data-linea="5">
    			<label for="dosis_envase">Número de dosis por envase: </label>
    			<input type="text" id="dosis_envase" name="dosis_envase" maxlength="128" />
    		</div>		
            	...
            	<div data-linea="5">
        			<table id="tbItemsPresentacionComercial" style="width:100%">
        				<thead>
        					<tr>
        						<th style="width: 10%;">#</th>
        						<th style="width: 10%;">Subcódigo</th>
        						<th style="width: 30%;">Presentación y descripción del envase</th>
                                <th style="width: 25%;">Cantidad (U)</th>
                                <th style="width: 10%;">Num. Dosis</th>
...
<div class="pestania">
    ...
    <form id='formularioPaso5' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='solicitud/guardar' data-destino="detalleItem" method="post">
    	...
    	<fieldset>
    		<legend>Método de Fabricación</legend>
    		
    		<div data-linea="4">
    			<label for="metodo_fabricacion">Método de fabricación: </label>
    			<input type="text" id="metodo_fabricacion" name="metodo_fabricacion" value="<?php echo $this->modeloSolicitud->getMetodoFabricacion(); ?>" maxlength="2048" class="formulario"/>
    		</div>
    	</fieldset>
    	...
    	<fieldset>
    		...
    		<div data-linea="5">
    			<label for="caracteristicas_fis_quim">Características físicas y químicas del producto: </label>
    			<input type="text" id="caracteristicas_fis_quim" name="caracteristicas_fis_quim" value="<?php echo $this->modeloSolicitud->getCaracteristicasFisQuim(); ?>" maxlength="1024" class="formulario" />
    		</div>	
    	...
    	<fieldset>
    		<legend>Controles sobre el producto veterinario biológico terminado</legend>
    		
    		<div data-linea="6">
    			<label for="pruebas_biologicas">Pruebas  biológicas: </label>
    			<input type="text" id="pruebas_biologicas" name="pruebas_biologicas" value="<?php echo $this->modeloSolicitud->getPruebasBiologicas(); ?>" maxlength="512" class="formulario" />
    		</div>	    		
			...
			<div data-linea="8">
    			<label for="control_inocuidad">Control de inocuidad: </label>
    			<input type="text" id="control_inocuidad" name="control_inocuidad" value="<?php echo $this->modeloSolicitud->getControlInocuidad(); ?>" maxlength="512" class="formulario" />
    		</div>
    		<div data-linea="9">
    			<label for="control_inactivacion">Control de inactivación o modificación antigénico: </label>
    			<input type="text" id="control_inactivacion" name="control_inactivacion" value="<?php echo $this->modeloSolicitud->getControlInactivacion(); ?>" maxlength="512" class="formulario" />
    		</div>	    		
    		    		
    		<div data-linea="10">
    			<label for="control_eficacia_inmunologica">Control de eficacia inmunológica y potencia: </label>
    			<input type="text" id="control_eficacia_inmunologica" name="control_eficacia_inmunologica" value="<?php echo $this->modeloSolicitud->getControlEficaciaInmunologica(); ?>" maxlength="512" class="formulario" />
    		</div>
		
			<div data-linea="11">
    			<label for="control_adyuvantes">Control de adyuvantes: </label>
    			<input type="text" id="control_adyuvantes" name="control_adyuvantes" value="<?php echo $this->modeloSolicitud->getControlAdyuvantes(); ?>" maxlength="512" class="formulario" />
    		</div>				
    	</fieldset>	
    	
    	<div data-linea="9" class="editable">
			<button type="submit" class="guardar">Guardar</button>
		</div>
	</form>    	
</div>
...
<div class="pestania">
    ...
    <form id='formularioDosisViaAdministracion' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='DosisViaAdministracion/guardar' data-destino="detalleItem" method="post" class="editable">
    	<input type="hidden" id="id_solicitud" name="id_solicitud" value="<?php echo $this->modeloSolicitud->getIdSolicitud(); ?>" />
    	
    	<fieldset>
    		<legend>Dosis y Vía de Administración</legend>				
    
    		<div data-linea="1">
    			<label for="id_especie">Especie: </label>
    			<select id="id_especie_dosis" name="id_especie" >
                    <option value="">Seleccionar....</option>
                    <?php
                        echo $this->comboEspecies();
                    ?>
    		...
    		<div data-linea="2">
    			...
    			<input type="text" id="nombre_especie_dosis_administracion" name="nombre_especie" maxlength="128" />
    		</div>				
    
    		<div data-linea="3">
    			<label for="caracteristicas_animal">Características del animal (raza, fase etárea o productiva, etc.): </label>
    			<input type="text" id="caracteristicas_animal" name="caracteristicas_animal" maxlength="128" />
    		</div>		
    		
    		<div data-linea="4">
    			<label for="id_via_administracion">Vía administración: </label>
    			<select id="id_via_administracion" name="id_via_administracion" >
                    <option value="">Seleccionar....</option>
                    <?php
                        echo $this->comboViaAdministracion();
                    ?>
                </select>
    		</div>		
    		...
    		<div data-linea="5">
    			...
    			<input type="text" id="cantidad_dosis" name="cantidad_dosis" maxlength="128" />
    		</div>
    		
    		<div data-linea="5">
    			<label for="id_unidad_dosis">Unidad: </label>
    			<select id="id_unidad_dosis" name="id_unidad_dosis" >
                    <option value="">Seleccionar....</option>
                    <?php
                        echo $this->comboUnidadMedidaXId();
                    ?>
    		...
    		<div data-linea="6" class="NombreUnidadDosis">
    			<label for="nombre_unidad_dosis">Nombre unidad: </label>
    			<input type="text" id="nombre_unidad_dosis" name="nombre_unidad_dosis" maxlength="128" />
    		</div>		
    		...
    		<div data-linea="8">
    			<label for="cantidad">Cantidad: </label>
    			<input type="text" id="cantidad_dosis_via" name="cantidad" maxlength="128" />
    		</div>
    		...
    		<div data-linea="9" class="NombreUnidad">
    			<label for="nombre_unidad">Nombre unidad: </label>
    			<input type="text" id="nombre_unidad" name="nombre_unidad" maxlength="128" />
    		</div>		
    		...
    		<div data-linea="11">
    			...
    			<input type="text" id="duracion" name="duracion" maxlength="256" />
    		</div>
    		...
    		<div data-linea="11">
    			...
    			<input type="hidden" id="nombre_unidad_tiempo" name="nombre_unidad_tiempo" maxlength="32" />
    		</div>				
    ...
    <div id="tablaDosisViaAdministracion">
        <fieldset>
        	<legend>Dosis y Vía de Administración</legend>
            	<div data-linea="3">
        			<table id="tbItemsDosisViaAdministracion" style="width:100%">
        				<thead>
        					<tr>
        						<th style="width: 5%;">#</th>
        						<th style="width: 90%;">Especie de destino</th>
                                <th style="width: 5%;"></th>
        					</tr>
        				</thead>
        				<tbody>
   ...
   <form id='formularioCantidadDosis' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='CantidadDosis/guardar' data-destino="detalleItem" method="post" class="editable">
    	<input type="hidden" id="id_solicitud" name="id_solicitud" value="<?php echo $this->modeloSolicitud->getIdSolicitud(); ?>" />
    	
    	<fieldset>
    		<legend>Volumen por Dosis (Ej.: Una dosis = 1 ml)</legend>				
    
    		<div data-linea="1">
    			<label for="dosis">Volúmen: </label>
    			<input type="text" id="dosis" name="dosis" maxlength="128" />
    		</div>				
    
    		<div data-linea="2">
    			<label for="id_unidad_cantidad_dosis">Unidad: </label>
    			<select id="id_unidad_cantidad_dosis" name="id_unidad" >
                    <option value="">Seleccionar....</option>
                    <?php
                        echo $this->comboUnidadMedidaXId();
                    ?>
    		...
    		<div data-linea="3" class="NombreUnidadCantidadDosis">
    			<label for="nombre_unidad_cantidad_dosis">Nombre unidad: </label>
    			<input type="text" id="nombre_unidad_cantidad_dosis" name="nombre_unidad" maxlength="128" />
    		</div>
 	...
 	<div id="tablaCantidadDosis">
        <fieldset>
        	<legend>Volumen por Dosis (Ej.: Una dosis = 1 ml)</legend>
            	<div data-linea="3">
        			<table id="tbItemsCantidadDosis" style="width:100%">
        				<thead>
        					<tr>
        						<th style="width: 5%;">#</th>
        						<th style="width: 45%;">Volúmen</th>
        						<th style="width: 45%;">Unidad</th>
                                <th style="width: 5%;"></th>
        					</tr>
        				</thead>
        				<tbody>
    ...
    <form id='formularioPaso6' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='solicitud/guardar' data-destino="detalleItem" method="post">
    	...
    	<fieldset>
    		...
    		<div data-linea="1">
    			...
    			<input type="text" id="esquema_vacunacion" name="esquema_vacunacion" value="<?php echo $this->modeloSolicitud->getEsquemaVacunacion(); ?>" maxlength="512" class="formulario" />
    		</div>	
    	</fieldset>			
    
    	<fieldset>
    		<legend>Inmunidad</legend>
    		
    		<div data-linea="1">
    			<label for="tiempo_inmunidad">Tiempo para conferir inmunidad: </label>
    			<input type="text" id="tiempo_inmunidad" name="tiempo_inmunidad" value="<?php echo $this->modeloSolicitud->getTiempoInmunidad(); ?>" maxlength="256" class="formulario" />
    		</div>				
    
    		<div data-linea="2">
    			<label for="tiempo_minimo_inmunidad">Tiempo mínimo de duración de la inmunidad: </label>
    			<input type="text" id="tiempo_minimo_inmunidad" name="tiempo_minimo_inmunidad" value="<?php echo $this->modeloSolicitud->getTiempoMinimoInmunidad(); ?>" maxlength="256" class="formulario" />
    		</div>				   		
...
<div class="pestania">
    <form id='formularioPreparacion' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='solicitud/guardar' data-destino="detalleItem" method="post">
    	<input type="hidden" id="id_solicitud" name="id_solicitud" value="<?php echo $this->modeloSolicitud->getIdSolicitud(); ?>" />
    	
    	<fieldset>
    		<legend>Preparación, biodisponibilidad y contraindicaciones</legend>
    		
    		<div data-linea="1">
    			<label for="requiere_preparacion">Requiere preparación? </label>
    			<select id="requiere_preparacion" name="requiere_preparacion" required class="formulario">
                    <?php
                    echo $this->comboSiNo($this->modeloSolicitud->getRequierePreparacion());
                    ?>
                </select>
    		</div>				
    
    		<div data-linea="2" class="detallePreparacion">
    			<label for="detalle_preparacion">Detalle de preparación: </label>
    			<input type="text" id="detalle_preparacion" name="detalle_preparacion" value="<?php echo $this->modeloSolicitud->getDetallePreparacion(); ?>" maxlength="1024" class="formulario" />
    		</div>				
    
    		<div data-linea="3">
    			<label for="duracion_maxima">Duración máxima: </label>
    			<input type="number" id="duracion_maxima" name="duracion_maxima" value="<?php echo $this->modeloSolicitud->getDuracionMaxima(); ?>" min="0" step="0.01" class="formulario"/>
    		</div>				
    
    		<div data-linea="3">
    			<label for="id_tiempo_duracion_maxima">Tiempo: </label>
    			<select id="id_tiempo_duracion_maxima" name="id_tiempo_duracion_maxima" class="formulario">
                    <option value="">Seleccionar....</option>
                    <?php
                    echo $this->comboUnidadTiempoXId($this->modeloSolicitud->getIdTiempoDuracionMaxima());
                    ?>
                </select>
                
                <input type="hidden" id="nombre_unidad_tiempo_duracion" name="nombre_unidad_tiempo_duracion" value="<?php echo $this->modeloSolicitud->getNombreUnidadTiempoDuracion(); ?>" maxlength="32" class="formulario" />
    		</div>					
    		...
    		<div data-linea="6">
    			...
    			<input type="text" id="toxicidad" name="toxicidad" value="<?php echo $this->modeloSolicitud->getToxicidad(); ?>" maxlength="512" class="formulario" />
    		</div>				
    
    		
    		
    		<div data-linea="8" class="editable">
    			<button type="submit" class="guardar">Guardar</button>
    		</div>
	...
	<form id='formularioEfectoBiologico' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='EfectoBiologico/guardar' data-destino="detalleItem" method="post" class="editable">
    	<input type="hidden" id="id_solicitud" name="id_solicitud" value="<?php echo $this->modeloSolicitud->getIdSolicitud(); ?>" />
    	...
    	<fieldset>
    		...
    		<div data-linea="1">
    			<label for="id_efecto">Efecto biológico no deseado: </label>
    			<select id="id_efecto" name="id_efecto">
                    <option value="">Seleccionar....</option>
                    <?php
                        echo $this->comboEfectosBiologicos();
                    ?>
                </select>
    		</div>				
    
    		<div data-linea="5">
    			<label for="descripcion_efecto_biologico">Descripción: </label>
    			<input type="text" id="descripcion_efecto_biologico" name="descripcion_efecto_biologico" maxlength="512" />
    		</div>
    ...
    <div id="tablaEfectoBiologico">
        <fieldset>
        	<legend>Efectos biológicos no deseados</legend>
            	<div data-linea="3">
        			<table id="tbItemsEfectoBiologico" style="width:100%">
        				<thead>
        					<tr>
        						<th style="width: 5%;">#</th>
        						<th style="width: 45%;">Efecto biológico</th>
...
<div class="pestania">
	<form id='formularioPeriodoVidaUtil' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='PeriodoVidaUtil/guardar' data-destino="detalleItem" method="post" class="editable">
    	...
    	<fieldset>
    		...
    		<div data-linea="6">
    			<label for="id_unidad_tiempo">Tiempo: </label>
    			<select id="id_unidad_tiempo_vida_util" name="id_unidad_tiempo">
                    <option value="">Seleccionar....</option>
                    <?php
                        echo $this->comboUnidadTiempoXId();
                    ?>
    ...
    <form id='formularioConservacion' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='solicitud/guardar' data-destino="detalleItem" method="post">
    	...
    	<fieldset>
    		<legend>Precauciones generales</legend>
    		...
    		<div data-linea="2">
    			<label for="variacion_calidad">Causas que pueden hacer variar la calidad del producto: </label>
    			<input type="text" id="variacion_calidad" name="variacion_calidad" value="<?php echo $this->modeloSolicitud->getVariacionCalidad(); ?>" maxlength="1024" class="formulario" />
    		</div>				
    	...
    	<fieldset>
    		...
    		<div data-linea="3">
    			<label for="recomendacion_conservacion">Recomendaciones de conservación: </label>
    			<input type="text" id="recomendacion_conservacion" name="recomendacion_conservacion" value="<?php echo $this->modeloSolicitud->getRecomendacionConservacion(); ?>" maxlength="128" class="formulario" />
    		</div>	
    		
    		<div data-linea="4">
    			<label for="duracion_maxima_reconstitucion">Duración máxima después de reconstitución: </label>
    			<input type="text" id="duracion_maxima_reconstitucion" name="duracion_maxima_reconstitucion" value="<?php echo $this->modeloSolicitud->getDuracionMaximaReconstitucion(); ?>" maxlength="128" class="formulario" />
    		</div>
    		
    		<div data-linea="5">
    			<label for="condiciones_almacenamiento_abierto">Condiciones de almacenamiento una vez abierto: </label>
    			<input type="text" id="condiciones_almacenamiento_abierto" name="condiciones_almacenamiento_abierto" value="<?php echo $this->modeloSolicitud->getCondicionesAlmacenamientoAbierto(); ?>" maxlength="128" class="formulario" />
    		</div>			
...
<div class="pestania"> 
    <form id='formularioDeclaracionVenta' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='solicitud/guardar' data-destino="detalleItem" method="post">
    	<input type="hidden" id="id_solicitud" name="id_solicitud" value="<?php echo $this->modeloSolicitud->getIdSolicitud(); ?>" />
...
var combo = "<option>Seleccione....</option>";
	...
	$(document).ready(function() {
		...
		//***PASO 6
		$(".NombreUnidadDosis").hide();
		$(".NombreUnidad").hide();
		$(".NombreUnidadCantidadDosis").hide();
		fn_mostrarDetalleUsoEspecie();
		fn_mostrarDetalleDosisViaAdministracion();
		fn_mostrarDetalleCantidadDosis();

		//***PASO 7
		$(".detallePreparacion").hide();
		fn_mostrarDetalleEfectoBiologico();

		//***PASO 8
		fn_mostrarDetallePeriodoVidaUtil();

		//***PASO 9
		//fn_mostrarDetallePeriodoRetiro();
  ...
  //Para origen de producto grid
    $("#formularioPresentacionComercial").submit(function (event) {
        ...
        if(!$.trim($("#dosis_envase").val())){
        	error = true;
        	$("#dosis_envase").addClass("alertaCombo");
		}
  ...
  //Para origen de producto grid
    ...
    $("#formularioPaso5").submit(function (event) {
		...
		if($.trim($("#metodo_fabricacion").val())){
			if(!esCampoValido("#metodo_fabricacion")){
            	error = true;
            	$("#metodo_fabricacion").addClass("alertaCombo");
			}
		}
		...
		if($.trim($("#pruebas_biologicas").val())){
			if(!esCampoValido("#pruebas_biologicas")){
            	error = true;
            	$("#pruebas_biologicas").addClass("alertaCombo");
			}
		}
		...
		if($.trim($("#control_inocuidad").val())){
			if(!esCampoValido("#control_inocuidad")){
            	error = true;
            	$("#control_inocuidad").addClass("alertaCombo");
			}
		}

		if($.trim($("#control_inactivacion").val())){
			if(!esCampoValido("#control_inactivacion")){
            	error = true;
            	$("#control_inactivacion").addClass("alertaCombo");
			}
		}

		if($.trim($("#control_eficacia_inmunologica").val())){
			if(!esCampoValido("#control_eficacia_inmunologica")){
            	error = true;
            	$("#control_eficacia_inmunologica").addClass("alertaCombo");
			}
		}

		if($.trim($("#control_adyuvantes").val())){
			if(!esCampoValido("#control_adyuvantes")){
            	error = true;
            	$("#control_adyuvantes").addClass("alertaCombo");
			}
		}
    ...
    $("#id_unidad_dosis").change(function () {
    	if ($("#id_unidad_dosis option:selected").val() !== "") {
    		if ($("#id_unidad_dosis option:selected").val() != "0") {
        		$("#nombre_unidad_dosis").val($("#id_unidad_dosis option:selected").attr('data-codigo'));
        		$("#nombre_unidad_dosis").removeAttr('required');
        		$(".NombreUnidadDosis").hide();
        	}else{
        		$("#nombre_unidad_dosis").val('');
        		$("#nombre_unidad_dosis").attr('required', 'required');
        		$(".NombreUnidadDosis").show();
        	}
    	}else{
    		$("#nombre_unidad_dosis").val("");
    		$(".NombreUnidadDosis").hide();
    ...
    $("#id_unidad").change(function () {
    	if ($("#id_unidad option:selected").val() !== "") {
    		if ($("#id_unidad option:selected").val() != "0") {
        		$("#nombre_unidad").val($("#id_unidad option:selected").attr('data-codigo'));
        		$("#nombre_unidad").removeAttr('required');
        		$(".NombreUnidad").hide();
        	}else{
        		$("#nombre_unidad").val('');
        		$("#nombre_unidad").attr('required', 'required');
        		$(".NombreUnidad").show();
        	}
    	}else{
    		$("#nombre_unidad").val("");
    ...
    $("#id_unidad_tiempo").change(function () {
    	if ($("#id_unidad_tiempo").val() !== "") {
    		$("#nombre_unidad_tiempo").val($("#id_unidad_tiempo option:selected").attr('data-codigo'));
    	}else{
    		$("#nombre_unidad_tiempo").val("");
    	}
    });

    $("#formularioDosisViaAdministracion").submit(function (event) {
		fn_limpiar();
		event.preventDefault();
		var error = false;
		
		if(!$.trim($("#id_especie_dosis").val())){
        	error = true;
        	$("#id_especie_dosis").addClass("alertaCombo");
		}
		
		if(!$.trim($("#id_via_administracion").val())){
        	error = true;
        	$("#id_via_administracion").addClass("alertaCombo");
		}

		if(!$.trim($("#cantidad_dosis").val())){
        	error = true;
        	$("#cantidad_dosis").addClass("alertaCombo");
		}
		
		if(!$.trim($("#id_unidad_dosis").val())){
        	error = true;
        	$("#id_unidad_dosis").addClass("alertaCombo");
		}

		if($("#id_unidad_dosis option:selected").val() == '0'){
            if(!$.trim($("#nombre_unidad_dosis").val())){
            	error = true;
            	$("#nombre_unidad_dosis").addClass("alertaCombo");
    		}
        }
		
		if(!$.trim($("#cantidad_dosis_via").val())){
        	error = true;
        	$("#cantidad_dosis_via").addClass("alertaCombo");
		}

		if(!$.trim($("#id_unidad").val())){
        	error = true;
        	$("#id_unidad").addClass("alertaCombo");
		}

		if($("#id_unidad option:selected").val() == '0'){
            if(!$.trim($("#nombre_unidad").val())){
            	error = true;
            	$("#nombre_unidad").addClass("alertaCombo");
    		}
        }
		...
		if (!error) {
	        var respuesta = JSON.parse(ejecutarJson($(this)).responseText);
	       	if (respuesta.estado == 'exito'){
	       		fn_mostrarDetalleDosisViaAdministracion();
	       		fn_limpiarDosisViaAdministracionCompleto();
	        }else{
	        	fn_mostrarDetalleDosisViaAdministracion();
	        }
		} else {
    ...
    //Para cargar el detalle de Dosis y Via de Administracion
    function fn_mostrarDetalleDosisViaAdministracion() {
        var idSolicitud = $("#id_solicitud").val();
        
    	$.post("<?php echo URL ?>DossierPecuario/DosisViaAdministracion/construirDetalleDosisViaAdministracion/",
    	{
			idSolicitud : idSolicitud,
			fase : bandera
		}, function (data) {
            $("#tbItemsDosisViaAdministracion tbody").html(data);
        });
    }

  	//Funcion que elimina una fila de la lista 
    function fn_eliminarDetalleDosisViaAdministracion(idDetalleDosisViaAdministracion) { 
        $.post("<?php echo URL ?>DossierPecuario/DosisViaAdministracion/borrar",
        {                
            elementos: idDetalleDosisViaAdministracion
        },
        function (data) {
        	fn_mostrarDetalleDosisViaAdministracion();
        });
    ...
    function fn_limpiarDosisViaAdministracionCompleto() {
    	$("#id_especie").val("");
    	$("#nombre_especie").val("");
    	$("#caracteristicas_animal").val("");
    ...
    $("#id_unidad_cantidad_dosis").change(function () {
    	if ($("#id_unidad_cantidad_dosis option:selected").val() !== "") {
    		if ($("#id_unidad_cantidad_dosis option:selected").val() != "0") {
        		$("#nombre_unidad_cantidad_dosis").val($("#id_unidad_cantidad_dosis option:selected").attr('data-codigo'));
        		$("#nombre_unidad_cantidad_dosis").removeAttr('required');
        		$(".NombreUnidadCantidadDosis").hide();
        	}else{
        		$("#nombre_unidad_cantidad_dosis").val('');
        		$("#nombre_unidad_cantidad_dosis").attr('required', 'required');
        		$(".NombreUnidadCantidadDosis").show();
        	}
    	}else{
    		$("#nombre_unidad_cantidad_dosis").val("");
    		$(".NombreUnidadCantidadDosis").hide();
    ...
    $("#formularioCantidadDosis").submit(function (event) {
		fn_limpiar();
		event.preventDefault();
		var error = false;
		...
		if(!$.trim($("#id_unidad_cantidad_dosis").val())){
        	error = true;
        	$("#id_unidad_cantidad_dosis").addClass("alertaCombo");
		}

		if($("#id_unidad_cantidad_dosis option:selected").val() == '0'){
            if(!$.trim($("#nombre_unidad_cantidad_dosis").val())){
            	error = true;
            	$("#nombre_unidad_cantidad_dosis").addClass("alertaCombo");
    		}
        }
		...
		if (!error) {
	        var respuesta = JSON.parse(ejecutarJson($(this)).responseText);
	       	if (respuesta.estado == 'exito'){
	       		fn_mostrarDetalleCantidadDosis();
	       		fn_limpiarCantidadDosisCompleto();
	        }else{
	        	fn_mostrarDetalleCantidadDosis();
	        }
		} else {
    ...
    //Para cargar el detalle de Cantidad de Dosis
    function fn_mostrarDetalleCantidadDosis() {
        var idSolicitud = $("#id_solicitud").val();
        
    	$.post("<?php echo URL ?>DossierPecuario/CantidadDosis/construirDetalleCantidadDosis/",
    	{
			idSolicitud : idSolicitud,
			fase : bandera
		}, function (data) {
            $("#tbItemsCantidadDosis tbody").html(data);
        });
    }

  	//Funcion que elimina una fila de la lista 
    function fn_eliminarDetalleCantidadDosis(idDetalleCantidadDosis) { 
        $.post("<?php echo URL ?>DossierPecuario/CantidadDosis/borrar",
        {                
            elementos: idDetalleCantidadDosis
        },
        function (data) {
        	fn_mostrarDetalleCantidadDosis();
        });
    ...
    function fn_limpiarCantidadDosisCompleto() {
    	$("#dosis").val("");
    	$("#id_unidad_cantidad_dosis").val("");
    	$("#nombre_unidad_cantidad_dosis").val("");
    }
    ...
    $("#formularioPaso6").submit(function (event) {
		...
		if($.trim($("#esquema_vacunacion").val())){
			if(!esCampoValido("#esquema_vacunacion")){
            	error = true;
            	$("#esquema_vacunacion").addClass("alertaCombo");
			}
		}

		if($.trim($("#tiempo_inmunidad").val())){
			if(!esCampoValido("#tiempo_inmunidad")){
            	error = true;
            	$("#tiempo_inmunidad").addClass("alertaCombo");
			}
		}

		if($.trim($("#tiempo_minimo_inmunidad").val())){
			if(!esCampoValido("#tiempo_minimo_inmunidad")){
            	error = true;
            	$("#tiempo_minimo_inmunidad").addClass("alertaCombo");
			}
		}
    ...
    /************************************* PASO 7 ***************************************/
    $("#requiere_preparacion").change(function () {
    	if ($("#requiere_preparacion").val() == "Si") {
    		$(".detallePreparacion").show();
    		$("#detalle_preparacion").attr('required', 'required');
    	}else{
    		$(".detallePreparacion").hide();
    		$("#detalle_preparacion").removeAttr('required');
    	}
    });

    $("#id_tiempo_duracion_maxima").change(function () {
    	if ($("#id_tiempo_duracion_maxima").val() !== "") {
    		$("#nombre_unidad_tiempo_duracion").val($("#id_tiempo_duracion_maxima option:selected").attr('data-codigo'));
    	}else{
    		$("#nombre_unidad_tiempo_duracion").val("");
    	}
    });
    
    $("#formularioPreparacion").submit(function (event) {
		event.preventDefault();
		var error = false;

		if(!$.trim($("#requiere_preparacion").val())){
        	error = true;
        	$("#requiere_preparacion").addClass("alertaCombo");
		}

		//Poner validacion de contenido de texto si hay informacion en los campos
		if($("#requiere_preparacion").val() == 'Si'){
    		if(!$.trim($("#detalle_preparacion").val())){
            	error = true;
            	$("#detalle_preparacion").addClass("alertaCombo");
    		}
        }
        
		if($.trim($("#duracion_maxima").val())){
			if(!esCampoValido("#duracion_maxima")){
            	error = true;
            	$("#duracion_maxima").addClass("alertaCombo");
			}
		}else{
			$("#duracion_maxima").val('0');
		}

		if($.trim($("#id_tiempo_duracion_maxima").val())){
			if(!esCampoValido("#id_tiempo_duracion_maxima")){
            	error = true;
            	$("#id_tiempo_duracion_maxima").addClass("alertaCombo");
			}
		}
		...
		if($.trim($("#toxicidad").val())){
			if(!esCampoValido("#toxicidad")){
            	error = true;
            	$("#toxicidad").addClass("alertaCombo");
			}
		}
    ...
    $("#formularioEfectoBiologico").submit(function (event) {
		fn_limpiar();
		event.preventDefault();
		var error = false;
		
		if(!$.trim($("#id_efecto").val())){
        	error = true;
        	$("#id_efecto").addClass("alertaCombo");
		}
		
		if(!$.trim($("#descripcion_efecto_biologico").val())){
        	error = true;
        	$("#descripcion_efecto_biologico").addClass("alertaCombo");
		}
		...
		if (!error) {
	        var respuesta = JSON.parse(ejecutarJson($(this)).responseText);
	       	if (respuesta.estado == 'exito'){
	       		fn_mostrarDetalleEfectoBiologico();
	       		fn_limpiarEfectoBiologicoCompleto();
	        }else{
	        	fn_mostrarDetalleEfectoBiologico();
	        }
		} else {
    ...
    //Para cargar el detalle de Efectos biológicos
    function fn_mostrarDetalleEfectoBiologico() {
        var idSolicitud = $("#id_solicitud").val();
        
    	$.post("<?php echo URL ?>DossierPecuario/EfectoBiologico/construirDetalleEfectoBiologico/",
    	{
			idSolicitud : idSolicitud,
			fase : bandera
		}, function (data) {
            $("#tbItemsEfectoBiologico tbody").html(data);
        });
    }

  	//Funcion que elimina una fila de la lista 
    function fn_eliminarDetalleEfectoBiologico(idDetalleEfectoBiologico) { 
        $.post("<?php echo URL ?>DossierPecuario/EfectoBiologico/borrar",
        {                
            elementos: idDetalleEfectoBiologico
        },
        function (data) {
        	fn_mostrarDetalleEfectoBiologico();
        });
    ...
    function fn_limpiarEfectoBiologicoCompleto() {
    	$("#id_efecto").val("");
    	$("#descripcion_efecto_biologico").val("");
    }

    /************************************* PASO 8 ***************************************/    
    $("#id_unidad_tiempo_vida_util").change(function () {
    	if ($("#id_unidad_tiempo_vida_util").val() !== "") {
    		$("#nombre_unidad_periodo_vida").val($("#id_unidad_tiempo_vida_util option:selected").attr('data-codigo'));
    	}else{
    ...
    $("#formularioPeriodoVidaUtil").submit(function (event) {
		...
		if(!$.trim($("#id_unidad_tiempo_vida_util").val())){
        	error = true;
        	$("#id_unidad_tiempo_vida_util").addClass("alertaCombo");
		}
    ...
    $("#formularioConservacion").submit(function (event) {
		...
		if($.trim($("#variacion_calidad").val())){
			if(!esCampoValido("#variacion_calidad")){
            	error = true;
            	$("#variacion_calidad").addClass("alertaCombo");
			}
		}
		...
		if($.trim($("#recomendacion_conservacion").val())){
			if(!esCampoValido("#recomendacion_conservacion")){
            	error = true;
            	$("#recomendacion_conservacion").addClass("alertaCombo");
			}
		}

		if($.trim($("#duracion_maxima_reconstitucion").val())){
			if(!esCampoValido("#duracion_maxima_reconstitucion")){
            	error = true;
            	$("#duracion_maxima_reconstitucion").addClass("alertaCombo");
			}
		}

		if($.trim($("#condiciones_almacenamiento_abierto").val())){
			if(!esCampoValido("#condiciones_almacenamiento_abierto")){
            	error = true;
            	$("#condiciones_almacenamiento_abierto").addClass("alertaCombo");
			}
		}
    ...
    /************************************* PASO 9 ***************************************/    
    $("#formularioDeclaracionVenta").submit(function (event) {
    	fn_limpiar();
		event.preventDefault();
		var error = false;
