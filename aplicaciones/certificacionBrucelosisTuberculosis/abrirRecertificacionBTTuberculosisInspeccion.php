...
<header>
	<h1>Predios para Recertificación como Libres de Tuberculosis Bovina</h1>
</header>
...
<div class="pestania">
	...
	<form id="cerrarCertificacionBT" data-rutaAplicacion="<?php echo $ruta;?>" data-opcion="guardarCierreRecertificacionBTTecnico" data-destino="detalleItem" data-accionEnExito="ACTUALIZAR">
		...
		<input type='hidden' id='numRecertificacion' name='numRecertificacion' value="<?php echo $certificacionBT['num_recertificacion'];?>" />
