...
$ext   = '.xls';
$nomReporte = 'estados_RIAF_'.$fecha.$ext;
...
$queryReporte = $cf->obtenerRegistrosFertilizantes($conexion);
...
<body>
	<div id="header">
		...
		<div id="textoEncabezado" style="font-size: 16px; font-weight: bold;">
			...
			<br>AGROCALIDAD
         <br>REPORTE DE ESTADOS DE SOLICITUDES DEL DOSSIER DE FERTILIZANTES
		</div>
