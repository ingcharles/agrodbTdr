...
<html>
	...
	<body>
		<div id="header">
			...
			<div id="imprimir">
				<form id="filtrar" action="reporteCertificacionBTDetalleExcel.php" target="_blank" method="post">
					 ...
					 while($certificacionesBT = pg_fetch_assoc($certificacionesBTCabecera)){
					 	...
					 	echo '<tr>
								...
								<td class="formatoTexto">'.$certificacionesBT['observaciones'].'</td>
				 				<td class="formatoTexto">'.$certificacionesBT['fecha_creacion'].'</td>
								<td class="formatoTexto">'.$certificacionesBT['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $certificacionesBT['identificador']));
					 	...
					 	for($i=0;$i<$mayor;$i++){
				 			...
				 			echo ' <td class="formatoTexto">'.$predio[$i]['id_certificacion_bt'].'</td>
							        ...
							        <td class="formatoTexto">'.$predio[$i]['superficie_predio'].'</td>
					 				...
					 				<td class="formatoTexto">'.$predio[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$predio[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $predio[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
									...
									<td class="formatoTexto">'.$produccionCBT[$i]['tipo_explotacion'].'</td>
					 				<td class="formatoTexto">'.$produccionCBT[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$produccionCBT[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $produccionCBT[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
									...
									<td class="formatoTexto">'.$inventarioCBT[$i]['numero_animales_predio'].'</td>
					 				<td class="formatoTexto">'.$inventarioCBT[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$inventarioCBT[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $inventarioCBT[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
							        ...
							        <td class="formatoTexto">'.$pediluvioCBT[$i]['pediluvio'].'</td>
					 				<td class="formatoTexto">'.$pediluvioCBT[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$pediluvioCBT[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $pediluvioCBT[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
									...
									<td class="formatoTexto">'.$manejoAnimalCBT[$i]['arrienda_otros_potreros'].'</td>
					 				...
					 				<td class="formatoTexto">'.$manejoAnimalCBT[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$manejoAnimalCBT[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $manejoAnimalCBT[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
									...
									<td class="formatoTexto">'.$adquisicion[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$adquisicion[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $adquisicion[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
							        ...
							        <td class="formatoTexto">'.$aguaCBT[$i]['num_inspeccion'].'</td>
					 				...
					 				<td class="formatoTexto">'.$aguaCBT[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$aguaCBT[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $aguaCBT[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
									...
									<td class="formatoTexto">'.$veterinarioCBT[$i]['correo_electronico_veterinario'].'</td>
					 				...
					 				<td class="formatoTexto">'.$veterinarioCBT[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$veterinarioCBT[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $veterinarioCBT[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
						    		...
						    		<td class="formatoTexto">'.$vacunacionCBT[$i]['fecha_vacunacion'].'</td>
					 				<td class="formatoTexto">'.$vacunacionCBT[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$vacunacionCBT[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $vacunacionCBT[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
									...
									<td class="formatoTexto">'.$reproduccionCBT[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$reproduccionCBT[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $reproduccionCBT[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
						    		...
						    		<td class="formatoTexto">'.$patologiaTuberculosisCBT[$i]['abultamiento'].'</td>
					 				...
					 				<td class="formatoTexto">'.$patologiaTuberculosisCBT[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$patologiaTuberculosisCBT[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $patologiaTuberculosisCBT[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
									...
									<td class="formatoTexto">'.$pruebasTuberculinaCBT[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$pruebasTuberculinaCBT[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $pruebasTuberculinaCBT[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
							        ...
							        <td class="formatoTexto">'.$patologiaCBT[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$patologiaCBT[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $patologiaCBT[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
							        ...
							        <td class="formatoTexto">'.$abortosCBT[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$abortosCBT[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $abortosCBT[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
							        ...
							        <td class="formatoTexto">'.$pruebasLecheCBT[$i]['laboratorio'].'</td>
					 				<td class="formatoTexto">'.$pruebasLecheCBT[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$pruebasLecheCBT[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $pruebasLecheCBT[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
							        ...
							        <td class="formatoTexto">'.$pruebasSangreCBT[$i]['destino_animales_positivos'].'</td>
		 							<td class="formatoTexto">'.$pruebasSangreCBT[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$pruebasSangreCBT[$i]['identificador'].'</td>';
					 				$usuario = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $pruebasSangreCBT[$i]['identificador']));
					 		echo ' <td class="formatoTexto">'.$usuario['nombre'].' '.$usuario['apellido'].'</td>
							        ...
							        <td class="formatoTexto">'.$resultadoLaboratorioCBT[$i]['observaciones'].'</td>
		 							...
		 							<td class="formatoTexto">'.$resultadoLaboratorioCBT[$i]['fecha_creacion'].'</td>
		 							<td class="formatoTexto">'.$resultadoLaboratorioCBT[$i]['identificador'].'</td>					        		
