...
/**
 * This class stands for endDateTime StructType
 * @subpackage Structs
 */
class EndDateTime extends AbstractStructBase
{
    /**
     * The DateTimeString
    ...
    /**
     * Constructor method for endDateTime
     * @uses EndDateTime::setDateTimeString()
