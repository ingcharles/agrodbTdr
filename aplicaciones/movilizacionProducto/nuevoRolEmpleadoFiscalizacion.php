...
<form id='nuevoEmpleado' data-rutaAplicacion='movilizacionProducto' data-destino='detalleItem' data-opcion='guardarNuevoRolEmpleadoFiscalizacion' data-accionEnExito="ACTUALIZAR">
	...
	<fieldset>
		<legend>Empleado</legend>
		  ...
		  <div data-linea="2">
			<label>Rol: </label> Digitador fiscalización para faenador
			<input id="rol" name="rol" type="hidden" value='digitadorFaenador' readonly='readonly' />
		</div>  			   			   		   			   			
	</fieldset>	
...
<script type="text/javascript">			
    ...
    $("#nuevoEmpleado").submit(function(event){		
		...
		if (!error){
			...
			$("#nuevoEmpleado").attr('data-opcion','guardarNuevoRolEmpleadoFiscalizacion');   
