...
<form id="enviarCierre" data-rutaAplicacion="programacionAnualPresupuestaria" data-opcion="cerrarProcesoDGAF" data-accionEnExito="ACTUALIZAR" >
	<input type='hidden' id='identificador' name='identificador' value="<?php echo $identificador;?>" />
	
	<p>Al finalizar el proceso, los <b>Presupuestos Revisados por la Dirección General Administrativa Financiera</b> 
	serán <b>aprobados</b> para la generación de la Matriz PAP final.</p>
