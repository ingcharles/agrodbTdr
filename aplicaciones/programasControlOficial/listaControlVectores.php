...
<header>
	...
	<nav>
		<form id="listaControlVectores" data-rutaAplicacion="programasControlOficial" data-opcion="listaControlVectoresFiltrada" data-destino="tabla">
			<table class="filtro">
				<tr>
...
<script>
	...
	$("#listaControlVectores").submit(function(e){
		abrir($(this),e,false);
	});
</script>