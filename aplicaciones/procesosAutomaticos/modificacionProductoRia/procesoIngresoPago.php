...
if(1){
    ...
    if(1){
		...
		while ($solicitudProducto = pg_fetch_assoc($qSolicitudProducto)) {
    		    ...
    		    $estado = "Por atender";
    		    $idArea = 'GENER'/*$solicitudProducto['id_area']*/;
    		    ...
    		    //if($idArea == "IAP"){    		    
    		    //    $servicio = pg_fetch_assoc($cf->obtenerIdServicioPorCodigoArea($conexion, $const::ITEM_TARIFARIO_IAV/*$const::ITEM_TARIFARIO_IAP*/, $idArea));
    		    //}else if($idArea == "IAV"){
    		    //    $servicio = pg_fetch_assoc($cf->obtenerIdServicioPorCodigoArea($conexion, $const::ITEM_TARIFARIO_IAV/*$const::ITEM_TARIFARIO_IAV*/, $idArea));
    		    //}else if($idArea == "IAF"){
    		        $servicio = pg_fetch_assoc($cf->obtenerIdServicioPorCodigoArea($conexion, $const::ITEM_TARIFARIO_IAV/*$const::ITEM_TARIFARIO_IAF*/, $idArea));
    		    //}
