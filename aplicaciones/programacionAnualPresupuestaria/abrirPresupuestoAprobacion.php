<?php 
	...
	if($presupuesto['identificador_aprobador'] == $identificador){
...
?>
	...
	<form id="regresar" data-rutaAplicacion="programacionAnualPresupuestaria" data-opcion="abrirPlanificacionAnualAprobacion" data-destino="detalleItem">
	...
	<table class="soloImpresion">
		<tr>
			<td>
				...
				<div id="revision">
					<form id="revisarPresupuesto" data-rutaAplicacion="programacionAnualPresupuestaria" data-opcion="revisarPresupuestoAprobador" data-destino="detalleItem">
						...
						<fieldset>
							...
							<div data-linea="1">
								...
								<select id=estadoRevision name="estadoRevision" required="required">
									...
									<option value="aprobadoDGAF">Revisado</option>
