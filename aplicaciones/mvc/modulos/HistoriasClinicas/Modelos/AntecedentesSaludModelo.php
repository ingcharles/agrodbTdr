<?php
/**
 * Modelo AntecedentesSaludModelo
 *
 * Este archivo se complementa con el archivo AntecedentesSaludLogicaNegocio.
 *
 * @author AGROCALIDAD
 * @date    2020-03-16
 * @uses AntecedentesSaludModelo
...
class AntecedentesSaludModelo extends ModeloBase{
	 ...
	 * @var Integer Campo requerido
	 *      Campo visible en el formulario
	 *      Llave foránea de la tabla tipo procedimiento_medico
	 */
	...
	/**
	 * Nombre de la tabla: antecedentes_salud
	 */
	private $tabla = "antecedentes_salud";

	/**
	 * Clave primaria
	 */
	private $clavePrimaria = "id_antecedentes_salud";

	/**
	 * Secuencia
	 */
	private $secuencial = 'g_historias_clinicas"."antecedentes_salud_id_antecedentes_salud_seq';
	...
	public function __set($name, $value){
		...
		if (! method_exists($this, $method)){
			throw new \Exception('Clase Modelo: AntecedentesSaludModelo. Propiedad especificada invalida: set' . $name);
		}
		$this->$method($value);
	}
	...
	public function __get($name){
		$method = 'get' . $name;
		if (! method_exists($this, $method)){
			throw new \Exception('Clase Modelo: AntecedentesSaludModelo. Propiedad especificada invalida: get' . $name);
		}
		return $this->$method();
	}
