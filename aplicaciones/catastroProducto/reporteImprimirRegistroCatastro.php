...
$ext   = '.xls';
$nomReporte = "REPORTE_CATASTRO_SANIDAD_ANIMAL_PORCINOS_".$fecha.$ext;
...
$res=$ccp->imprimirReporteRegistroCatastro($conexion, $provincia, $canton, $parroquia, $operacion, $fechaInicio, $fechaFin);
	...
	<tbody>
	 ...
	 while($fila = pg_fetch_assoc($res)){
	 	echo '<tr>	
				 ...
				 <td>'.$fila['producto'].'</td>
				 <td class="formatoTexto">'.$fila['activo'].'</td>
                 <td class="formatoTexto">'.$fila['inactivo'].'</td>
        	  </tr>';
	 }
