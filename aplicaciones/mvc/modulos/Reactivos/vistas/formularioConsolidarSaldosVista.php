        ...
        <div class="center-block" class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Registrar consolidado de saldos</h4>
                </div>
                <div class="form-horizontal">
                    <div class="modal-body">
                        <form id = 'frmResultados' data-rutaAplicacion = '<?php echo URL_MVC_FOLDER; ?>Reactivos'			 
                              data-opcion = 'SaldosLaboratorios/guardarConsolidado' data-destino ="detalleItem"			 
                            ...
                            <div class="form-group" >
                                <label for="" class="col-lg-4 control-label"> Raz&oacute;n salida</label>
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" value="CONSOLIDAR" readonly/>
                                </div>
                            </div>

                            <div class="form-group" >
                                <label for="tipo_ingreso" class="col-lg-4 control-label"> Tipo</label>
                                <div class="col-lg-6">
                                    <select id="tipo_ingreso" name="tipo_ingreso" class="form-control" required>
                            ...
                            <div class="form-group" >
                                <label for="autorizacion" class="col-lg-4 control-label"> Requiere autorizaci&oacute;n? </label>
                                <div class="col-lg-6">
                                    <select id="autorizacion" name="autorizacion" class="form-control" required>
                                        <option value="">Seleccionar....</option>
...
<?php echo $this->codigoJS; ?>
    ...
    function fn_verModalConsolidar(idReactivoLaboratorio, lote) {
        var url = "<?php echo URL ?>Reactivos/SaldosLaboratorios/editarSaldo";
        var data = {
