...
<body>
	...
	<form id="devolverPOARevisar" data-rutaAplicacion="poa" data-opcion="enviarPOARevisar" data-destino="detalleItem" data-accionEnExito="#ventanaAplicacion #filtrar"> <!--  data-accionEnExito="#ventanaAplicacion #filtrar" -->
		...
		<fieldset>
			...
			<div data-linea="5">
				...
				<?php echo $fila['actividad'].': <span class="destacar">'.$fila['detalle_actividad'].'</span>'?>
			</div>
			<!-- div data-linea="6">
	...
	<form id="revisarPAPP" data-rutaAplicacion="poa" data-opcion="revisarPAPP" data-destino="detalleItem" data-accionEnExito="#ventanaAplicacion #filtrar">
		 
		 <input type="hidden" name="idPlanta" value="<?php echo $id_item;?>"/>
		 <button id="botonRevisar" type="submit" class="guardar" <?php if($estado==4) echo "disabled='disabled'";  if($fila['revisado']=='t') echo "disabled='disabled'"; ?>>Revisar Proforma</button>
...
$("#revisarPAPP").submit(function(event){
	event.preventDefault();
	ejecutarJson(this);
});
