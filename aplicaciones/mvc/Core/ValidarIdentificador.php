...
class ValidarIdentificador
{
	...
	public function validarIdentificador($identificadorConsulta, $tipo){
		
		$resultado = FALSE;
		switch ($tipo){
			case 'Cédula':
				$nombreIdentificacion = 'Cédula incorrecta..!! ';
				$resultado =  $this->validarCedula($identificadorConsulta);
				break;
			case 'Pasaporte':
			case "Refugiado":
				return true;
			...
			case 'Natural':
				...
				$resultado = $this->validarRucPersonaNatural($identificadorConsulta);
				break;
			case 'Juridica':
				$nombreIdentificacion = 'RUC - Persona jurídica incorrecto..!! ';
				$resultado = $this->validarRucSociedadPrivada($identificadorConsulta);
				break;
			case 'Publica':
				$nombreIdentificacion = 'RUC - Sociedad Pública incorrecta..!! ';
				$resultado = $this->validarRucSociedadPublica($identificadorConsulta);
				break;
		}
		...
		if ($resultado) {
			...
			$mensaje['mensaje'] = $nombreIdentificacion;
		}
		return $mensaje;
	}
