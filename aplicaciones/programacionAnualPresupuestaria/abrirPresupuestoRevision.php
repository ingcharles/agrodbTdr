<?php 
	...
	if($presupuesto['revisado'] == true){
		...
		if($presupuesto['estado'] == 'enviadoAprobador'){
			$estadoRevision =1;
		}else{
			$estadoRevision = 0;
		}
...
?>
	...
	<form id="regresar" data-rutaAplicacion="programacionAnualPresupuestaria" data-opcion="abrirPlanificacionAnualRevision" data-destino="detalleItem">
	...
	<table class="soloImpresion">
		<tr>
			<td>
				...
				<div id="revision">
					<form id="revisarPresupuesto" data-rutaAplicacion="programacionAnualPresupuestaria" data-opcion="revisarPresupuesto" data-destino="detalleItem">
