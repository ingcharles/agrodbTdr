...
/**
 * This class stands for issueDateTime StructType
 * @subpackage Structs
 */
class IssueDateTime extends AbstractStructBase
{
    /**
     * The DateTimeString
    ...
    /**
     * Constructor method for issueDateTime
     * @uses IssueDateTime::setDateTimeString()
     ...
     * @param string $dateTimeString
     * @return \StructType\IssueDateTime
     */
