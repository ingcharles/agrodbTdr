...
<header>
	<h1>Reporte Matriz PAP Presupuestos</h1>
	<nav>
		<form id="filtrar" data-rutaAplicacion="programacionAnualPresupuestaria" data-opcion="guardarNuevaPlanificacionAnual" data-destino="detalleItem" action="aplicaciones/programacionAnualPresupuestaria/reporteMatrizPresupuestosAprobadorDetalle.php" target="_blank" method="post"> 
			...
			<table class="filtro">
				<tr>
					...
					<td>N4 - Dirección/ Distrital:</td>
						<td>	
							<div id="dN4Reporte">					
								<select id="areaN4ReportePresupuesto" name="areaN4ReportePresupuesto" >
									<option value="">Seleccione</option>
									<option value="">Todos</option>
								</select>
							</div>			
			...
			<tr>
					...
					<td>						
						<select id="estado" name="estado" >
							...
							<option value="enviadoAprobador">Enviado a DGAF</option>
							<option value="aprobadoDGAF">Revisado DGAF</option>
