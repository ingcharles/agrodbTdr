...
//if ($_SERVER['REMOTE_ADDR'] == '') {
   ...
   // if ($resultadoMonitoreo) {
        ...
        echo IN_MSG . 'Incremento 1 dia a funcionarios que cumplen mas 5 años bajo codigo de trabajo.';        //Incrementar dias a funcionarios que cumplieron 5 o mas años bajo el codigo de trabajo
        $cantidad = 480; //un dia 8 horas en minutos
        $cv->incrementoDiaPasadoCincoAnios($conexion, $anio, $cantidad);
        echo IN_MSG . "Fin Incremento";
