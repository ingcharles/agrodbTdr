...
<header>
	<h1>Notificación de Eventos Sanitarios</h1>
	<nav>
		<form id="listaNotificacionEventoSanitario" data-rutaAplicacion="seguimientoEventosSanitarios" data-opcion="listaNotificacionesEventoSanitarioFiltrada" data-destino="tabla">
			<table class="filtro">
				<tr>
				...
				<tr>	
					<th>Finca:</th>
					<td>
						<input type="text" id="bFinca" name="bFinca" />
					</td>
...
<script>
	...
	$("#listaNotificacionEventoSanitario").submit(function(e){
		abrir($(this),e,false);
	});
