...
switch ($tipoProtocolo) {
	...
	case 'protocoloRoya':
		...
		$res = $cci->generarReporteOrnamentalesProtocoloRoyaBlanca($conexion, $fechaInicio, $fechaFin, $identificadorUsuario, $nombreUsuario);
...
case 'protocoloAcaros':
	...
	$campos = array(
		...
		$res = $cci->generarReporteProtocoloAcaros($conexion, $fechaInicio, $fechaFin, $identificadorUsuario, $nombreUsuario);
...
case 'protocoloMinador':
	...
	$campos = array(
		...
		$res = $cci->generarReporteOrnamentalesProtocoloMinador($conexion, $fechaInicio, $fechaFin, $identificadorUsuario, $nombreUsuario);
	...
	case 'protocoloTrips':
		...
		$res = $cci->generarReporteOrnamentalesProtocoloTrips($conexion, $fechaInicio, $fechaFin, $identificadorUsuario, $nombreUsuario);
	...
	case 'protocoloDesvitalizacion':
		...
		$res = $cci->generarReporteProtocoloDesvitalizacion($conexion, $fechaInicio, $fechaFin, $identificadorUsuario, $nombreUsuario);
