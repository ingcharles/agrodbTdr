				...
				<table class="filtro" style='width: 400px;'>
					...
					<tr>
						...
						<td> <input id="identificadorProveedor" type="text" name="identificadorProveedor"
						 maxlength="13" style="width:100%"></td>
					</tr>
					<tr>
						<td>* Nombre Proveedor:</td>
						<td> <input id="nombreProveedor" type="text" name="nombreProveedor" style="width:100%">	</td>
					</tr>
					<tr>
					<td>Producto:</td>
					<td>					
					...
					<tr>
						<td>Fecha ingreso:</td>
						<td> <input id="fechaIngreso" type="text" name="fechaIngreso" style="width:100%"></td>
					</tr>
					<tr>
						<td>Estado:</td>
						<td> 
						<select id="estadoRegistro" name="estadoRegistro" style="width:100%">
							<option value="">Seleccione</option>
