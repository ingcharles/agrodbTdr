...
<header>
	<h1>Resultados de Laboratorio para Predios para Certificación como Libres de Brucelosis y Tuberculosis Bovina</h1>
</header>
	...
	<form id="nuevaPruebaLaboratorio" data-rutaAplicacion="<?php echo $ruta;?>" data-opcion="guardarPruebaLaboratorio" data-destino="detalleItem" data-accionEnExito="ACTUALIZAR">
		...
		<fieldset>
			...
			<div data-linea="55">
				...
				<button type="button" class="subirArchivoInforme" data-rutaCarga="aplicaciones/certificacionBrucelosisTuberculosis/informeLaboratorios/CertificacionBTLaboratorios">Subir informe de Laboratorio</button>
			</div>
		</fieldset>
