...
<header>
    <h1>Validar informaci&oacute;n</h1>
...
<table id="tablaItems">
    ...
    <tbody>
        <tr><td>Dar clic en Filtrar lista para mostrar los datos</td></tr>
    </tbody>
</table>
...
<?php echo $this->codigoJS ?>
    ...
    function fn_filtrar() {
        ...
        $.post("<?php echo URL ?>Laboratorios/BandejaResponsableTecnico/listarDatosValidar",
                {
