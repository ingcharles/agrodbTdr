...
?>
	...
	<form id="regresar" data-rutaAplicacion="reformaPresupuestaria" data-opcion="abrirReformaPlanificacionAnualRevisionDGPGE" data-destino="detalleItem">
	...
	<table class="soloImpresion">
		<tr>
			<td>
				...
				<div id="revision">
					<form id="revisarPresupuesto" data-rutaAplicacion="reformaPresupuestaria" data-opcion="revisarPresupuestoDGPGE" data-destino="detalleItem">
						...
						<fieldset>
							...
							<div data-linea="30">
								...
								<select id=estadoRevision name="estadoRevision" required="required">
									...
									<option value="revisadoDGPGE">Revisado</option>
