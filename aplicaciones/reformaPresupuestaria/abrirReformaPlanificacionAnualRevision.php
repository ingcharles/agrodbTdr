			...
			<table id="detallePresupuestos">
				...
				<?php 
					while ($presupuestos = pg_fetch_assoc($presupuesto)){
						echo $crp->imprimirLineaPresupuestoRevision($presupuestos['id_presupuesto'], $presupuestos['nombre_actividad'], $presupuestos['detalle_gasto'], 
															...
															$presupuestos['revisado'], $presupuestos['estado']);
					}
				?>
			</table>
		</fieldset>
