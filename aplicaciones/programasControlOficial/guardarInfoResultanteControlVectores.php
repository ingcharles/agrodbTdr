...
try{
	...
	try {
		...
		$inspeccionMH = $cpco->buscarInspeccionMurcielagosHematofagos($conexion, $idMurcielagosHematofagos, $numInspeccion, $idTipoRefugio);
		...
		if(pg_num_rows($inspeccionMH) == 0){
			$conexion->ejecutarConsulta("begin;");
				...
				$idMurcielagosHematofagosInspecciones = pg_fetch_result($cpco->nuevaInspeccionMurcielagosHematofagos($conexion, 
														...
														$fechaInspeccion, $idTipoRefugio, $tipoRefugio, $presenciaMH, $controlRealizado, 
			...
			$mensaje['mensaje'] = $cpco->imprimirLineaInspeccionMurcielagosHematofagos($idMurcielagosHematofagosInspecciones,
																...
																$tipoRefugio, $presenciaMH, $controlRealizado, $numMachos, 
