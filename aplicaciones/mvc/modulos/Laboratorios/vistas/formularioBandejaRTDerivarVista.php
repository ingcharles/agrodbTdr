...
<header>
    <h1>Derivaci&oacute;n muestras</h1>
</header>
<form id='formulario' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>Laboratorios'
      data-opcion='Solicitudes/nuevoDerivacion' data-destino="detalleItem"
      data-accionEnExito="ACTUALIZAR" method="post">
    <fieldset>
        <legend>Derivaci&oacute;n de las muestras</legend>
        <table id="muestras">
            <thead>
                <tr>
                    <th>#</th>
                    <th title="Clic para seleccionar la muestra a derivar">Derivar</th>
    ...
    <fieldset>
        <legend class='legendMuestras'>Datos para la Derivaci&oacute;n</legend>
...
<?php echo $this->codigoJS ?>
    ...
    $("#formulario").submit(function (event) {
        ...
        if ($('[name="muestras[]"]:checked').length > 0) {
            ...
            mostrarMensaje("Seleccione las muestras a derivar", "FALLO");
        }
    });
