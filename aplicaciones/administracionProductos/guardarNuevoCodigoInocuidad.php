...
try{
	...
	try {
		...
		$codigos = $cr -> guardarNuevoCodigoInocuidad($conexion, $idProductoIncouidad,$subcodigo, $presentacion);
		...
		$mensaje['mensaje'] = $cr->imprimirCodigoInocuidad($idProductoIncouidad, $subcodigo, $presentacion);
