...
?>
<header>
	<h1>Reporte de Catastro Cero de Sanidad Animal - Porcinos</h1>
	<nav>
		<form id="nuevoFiltroRegistroCatastro" data-rutaAplicacion="catastroProducto" action="aplicaciones/catastroProducto/reporteImprimirCatastroCero.php" target="_blank" method="post" >
		<input type="hidden" id="opcion" name="opcion" value="">

			<table class="filtro" >
				<tr>
					<th colspan="4">Filtros para el reporte de catastro cero en Sanidad Animal - Porcinos</th>
				</tr>
				<tr>
