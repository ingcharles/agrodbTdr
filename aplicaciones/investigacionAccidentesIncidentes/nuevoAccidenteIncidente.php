...
<form id="datosRegistro"
	...
	data-opcion="guardarRegistroSso"
	...
	<div class="pestania">
		<fieldset>
			...
			<div data-linea="1">
				<label>Accidente:</label> <input type="radio" id="op1" name="op"
					value="accidente" onclick="agregarOpcion(id);"/> <label>Incidente:</label> <input type="radio" id="op2"
					name="op" value="incidente" onclick="agregarOpcion(id);"/><div id="estadoOpcion"></div>
			</div>
			<input type="hidden" id="opcion" name="opcion"
					value="" />
			<input type="hidden" id="identificadorRegistro" name="identificadorRegistro" value="<?php echo $identificador;?>" />
		</fieldset>
		<fieldset>
			...
			<div data-linea="2">
				<label>* Nombre:</label> <input type="text" id="nombreServidor"
					name="nombreServidor" value="" readonly />
			</div>
			<div data-linea="3">
				<label>* Fecha Nacimiento:</label> <input type="text"
					id="fechaNacimiento" name="fechaNacimiento" value="" readonly />
			</div>
			<div data-linea="3">
			...
			<div data-linea="5">
				<label>* Estado Civil:</label> <input type="text" id="estadoCivil"
					name="estadoCivil" value="" readonly />
			</div>
			<div data-linea="7">
				<label>* Pertenece a un Grupo Vulnerable?:</label> <input type="text"
					id="tieneDiscapacidad" name="tieneDiscapacidad" value="" readonly />
			</div>
			<div data-linea="8">
				<label>* Dirección Domiciliaria:</label> <input type="text"
					id="domicilio" name="domicilio" value="" readonly />
			</div>
			
			<div data-linea="10">
				<label>* Provincia:</label> <input type="text" id="provincia"
					name="provincia" value="" readonly />
			</div>
			<div data-linea="10">
			...
			<div data-linea="13">
				<label>* Teléfono 1:</label> <input type="text" id="convencional"
					readonly name="convencional" value="" />
			</div>
			<div data-linea="13">
			...
			<div data-linea="15">
				<label>* Escolaridad:</label> <select name="escolaridad" id="escolaridad">
			...
			<div data-linea="15">
				<label>* Profesión:</label> <input type="text" id="profesion"
					name="profesion" value="" maxlength="16"/>
			</div>
			<div data-linea="17">
				<label>* Ocupación:</label> <input type="text" id="nombrePuesto"
					name="nombrePuesto" value="" readonly />
			</div>
			<div data-linea="18">
				<label>* Horario de Trabajo:</label> <input type="text"
					id="horarioTrab" name="horarioTrab" value="" maxlength="16"/>
			</div>
			<div data-linea="18">
				<label>* Tiempo Puesto de Trabajo:</label> <select
		...
		<fieldset>
			...
			<div data-linea="1">
				<label>* Día de la Semana:</label> <select name="diaSemana" id="diaSemana">
					<option value="">Seleccione...</option>
			...
			<div data-linea="2">
				<label>* Fecha del Accidente:</label> <input type="text"
					id="fechaSuceso" name="fechaSuceso" value=""
					data-er="^[A-Za-zñÑÁáÉéÍíÓóÚúÜü0-9#\- ]+$" readonly />

			</div>
			<div data-linea="2">
				<label>* Hora:</label> <input id="horaAccidente" name="horaAccidente"
					class="menores" value="" type="text" placeholder="10:30"
					data-inputmask="'mask': '99:99'" />

			</div>
			<div data-linea="4">
				<label>* Tipo de Accidente:</label> <select name="tipoAccidente" id="tipoAccidente">
					<option value="">Seleccione...</option>
			...
			<div data-linea="4">
				<label>* Lugar del Accidente:</label> <select name="lugarAccidente" id="lugarAccidente">
					<option value="">Seleccione...</option>
			...
			<div data-linea="6">
				<label>* Dirección:</label> <input type="text" id="direccion" name="direccion" value="" maxlength="64"/>
			</div>
			<div data-linea="7">
				<label>* Referencia:</label> <input type="text" id="referenciaAccidente" name="referenciaAccidente" maxlength="64"
					value="" />
			</div>
			<div data-linea="8">
	...
	<div class="pestania">
		<fieldset>
			...
			<div data-linea="2">
			<textarea style="width:150px; height: 60px;" id="describirAccidente" name="describirAccidente" maxlength="255"></textarea>
			</div>
			<div data-linea="3">
			...
			<div data-linea="5">
				<label>* Partes Lesionadas del Cuerpo:</label> <input type="text"
					id="partesLesionadas" name="partesLesionadas" value="" maxlength="64"/>
			</div>
			<div data-linea="6">
				<label>* Persona que lo Atendió Inmediatamente:</label> <input
					type="text" id="personaAtendio" name="personaAtendio" value="" maxlength="64"/>
			</div>
			<div data-linea="7">
				<label>* El Accidentado fue Trasladado a:</label> <input type="text" maxlength="64"
					id="trasladoAccidente" name="trasladoAccidente" value="" />
			</div>
		</fieldset>
		<fieldset>
			<legend>Información de Testigos</legend>
			<div data-linea="1">
				<label>Nombre:</label> <input type="text" id="nombreTestigo" name="nombreTestigo" value="" maxlength="64"/>
			</div>
			<div data-linea="2">
				<label>Dirección Domiciliaria:</label> <input type="text" id="direccionTestigo"
					name="direccionTestigo" value="" maxlength="128"/>
			</div>
			<div data-linea="3">
				<label>Teléfono:</label> <input type="text" name="telefonoTestigo" id="telefonoTestigo" value=""
		...
		<fieldset>
			...
			<div data-linea="1">
				<label>Lugar de Atención:</label> <input type="text" id="lugarAtencion" name="lugarAtencion"
					value="" maxlength="64"/>
			</div>
			<div data-linea="2">
				<label>Fecha de Atención:</label> <input type="text"
					id="fechaAtencion" name="fechaAtencion" value=""
					data-er="^[A-Za-zñÑÁáÉéÍíÓóÚúÜü0-9#\- ]+$" readonly />
			...
			<div data-linea="4">
				<label>Presenta Síntomas de:</label> <select name="presentaSintomas" id="presentaSintomas">
					<option value="">Seleccione...</option>
			...
			<div data-linea="4">
				<label>Otros Datos:</label> <select name="otrosDatos" id="otrosDatos">
					<option value="">Seleccione...</option>
			...
			<div data-linea="7">
				...
				<textarea style="width:152px; height: 60px;" id="descripcionLesiones" name="descripcionLesiones" maxlength="255"></textarea>
			</div>
			<div data-linea="8">
			...
			<div data-linea="9">
				<label>Nombre del Médico que Atiende:</label> <input type="text"
					id="nombreMedico" name="nombreMedico" value="" maxlength="64"/>
			</div>
			<div data-linea="10">
			...
			<div data-linea="10">
				<label>Desde:</label> <input type="text" id="fechaReposoDesde" name="fechaReposoDesde"
					value="" data-er="^[A-Za-zñÑÁáÉéÍíÓóÚúÜü0-9#\- ]+$" readonly/>
			</div>
			<div data-linea="10">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$("#identificadorUsuario").numeric();

		scanton = '<option value="">Seleccionar...</option>';
		...
		soficina = '<option value="">Seleccionar...</option>';
...
function buscarDatos(id){
	        ...
	        $('#estadoBusque').html('').addClass("alerta");
	        if(valor.length>=9){
	           var consulta = $.ajax({
	              type:'POST',
	           ...
	           consulta.fail(function(){
	              $('#estadoBusque').html('No existe ningun registro..!!').addClass("alerta");
	              return false;
	           });     
	        } else {
