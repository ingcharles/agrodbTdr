<?php 
	...
	$presupuestosRevisados = pg_fetch_result($cpp->numeroPresupuestosRevisados($conexion, $idProgramacionAnual, 'revisado'), 0, 'num_presupuestos_revisados');
	$presupuestosRechazados = pg_fetch_result($cpp->numeroPresupuestosRevisados($conexion, $idProgramacionAnual, 'rechazado'), 0, 'num_presupuestos_revisados');
	$presupuestosEnviadosRevisor = pg_fetch_result($cpp->numeroPresupuestosXEstado($conexion, $idProgramacionAnual, 'enviadoRevisor'), 0, 'num_presupuestos_revisados');
...
?>
	...
	<div class="pestania">
		...
		<div id="revision">
			<form id="revisarPlanificacionAnual" data-rutaAplicacion="programacionAnualPresupuestaria" data-opcion="revisarPlanificacionAnual" data-destino="detalleItem">
			...
			<table id="detallePresupuestos">
				<?php 
					while ($presupuestos = pg_fetch_assoc($presupuesto)){
						echo $cpp->imprimirLineaPresupuestoRevision($presupuestos['id_presupuesto'], $presupuestos['nombre_actividad'], $presupuestos['detalle_gasto'], 
