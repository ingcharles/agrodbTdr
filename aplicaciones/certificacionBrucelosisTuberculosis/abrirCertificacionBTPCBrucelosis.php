...
<div class="pestania">
	...
	<form id="cerrarCertificacionBT" data-rutaAplicacion="<?php echo $ruta;?>" data-opcion="guardarCierreCertificacionBTPC" data-destino="detalleItem" data-accionEnExito="ACTUALIZAR">
			...
			<div data-linea="53">
				<label>Resultado:</label>
					<select id="resultado" name="resultado" required="required" >
						<option value="inspeccion">Regresar a técnico</option>
					</select>					 					
			</div>
