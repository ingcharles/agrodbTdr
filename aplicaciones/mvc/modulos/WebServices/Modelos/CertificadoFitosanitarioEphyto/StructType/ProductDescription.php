...
class ProductDescription extends AbstractStructBase
{
     ...
     * @uses ProductDescription::setActive()
     * @uses ProductDescription::setCode()
     * @uses ProductDescription::setLang()
     * @uses ProductDescription::setLastModified()
     * @uses ProductDescription::setLastModifiedBy()
     * @uses ProductDescription::setName()
     * @param bool $active
     * @param string $code
     * @param string $lang
     ...
     * Set active value
     * @param bool $active
     * @return \StructType\ProductDescription
     */
