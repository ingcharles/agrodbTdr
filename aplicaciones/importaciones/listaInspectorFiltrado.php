...
$itemsFiltrados[] = array();
	...
	if($_POST['inspectores'] == ''){
		$res = $ci -> listarImportacionesRevisionProvincia($conexion, $_SESSION['nombreProvincia']);
	}else{
		$res = $ci -> listarImportacionesAsignadasInspector($conexion, $_SESSION['nombreProvincia'], $_POST['inspectores']);
	}
	...
	while($importaciones = pg_fetch_assoc($res)){
		...
		$itemsFiltrados[] = array('<tr
							...
							data-opcion="abrirImportacionEnviada"
