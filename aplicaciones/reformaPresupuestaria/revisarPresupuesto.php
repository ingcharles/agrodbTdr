	...
	try {
		...
		if ($idRevisor != ''){
			$conexion->ejecutarConsulta("begin;");
				$crp -> revisarPresupuestoTemporal($conexion, $idPresupuesto, $estado, $observaciones, $idRevisor);
				...
				$presupuestosRevisados = pg_fetch_result($crp->numeroPresupuestosRevisadosTemporal($conexion, $idPlanificacionAnual, 'revisado'), 0, 'num_presupuestos_revisados');
				...
				$presupuestosEnviadosRevisor = pg_fetch_result($crp->numeroPresupuestosXEstadoTemporal($conexion, $idPlanificacionAnual, 'enviadoRevisor'), 0, 'num_presupuestos_revisados');
				...
				if(($total['num_presupuestos'] - $presupuestosAprobados) == $presupuestosRevisados){
					$crp -> enviarPlanificacionAnualTemporal($conexion, $idPlanificacionAnual, 'revisado');
					
					//Ingresar fecha de revision y Observaciones
					$crp -> actualizarFechaRevisionReformaPlanificacionAnualTemporal($conexion, $idPlanificacionAnual, 'Revision', 'revisado');
				}
				
				$presupuestosEnviadosRevisionGF = pg_fetch_result($crp->numeroPresupuestosXEstadoTemporal($conexion, $idPlanificacionAnual, 'enviadoRevisorGF'), 0, 'num_presupuestos_revisados');
				$presupuestosEnviadosRevisionGA = pg_fetch_result($crp->numeroPresupuestosXEstadoTemporal($conexion, $idPlanificacionAnual, 'enviadoRevisorGA'), 0, 'num_presupuestos_revisados');
				$presupuestosRevisadosGA = pg_fetch_result($crp->numeroPresupuestosXEstadoTemporal($conexion, $idPlanificacionAnual, 'revisadoGA'), 0, 'num_presupuestos_revisados');
				$presupuestosEnviadosRevisionDGPGE = pg_fetch_result($crp->numeroPresupuestosXEstadoTemporal($conexion, $idPlanificacionAnual, 'enviadoRevisorDGPGE'), 0, 'num_presupuestos_revisados');
				$presupuestosRevisadosDGPGE = pg_fetch_result($crp->numeroPresupuestosXEstadoTemporal($conexion, $idPlanificacionAnual, 'revisadoDGPGE'), 0, 'num_presupuestos_revisados');
				
				if(($total['num_presupuestos'] - $presupuestosAprobados) == ($presupuestosRevisados + $presupuestosEnviadosRevisionGF + 
						$presupuestosEnviadosRevisionGA + $presupuestosRevisadosGA + $presupuestosEnviadosRevisionDGPGE + 
						$presupuestosRevisadosDGPGE)){
					$crp -> enviarPlanificacionAnualTemporal($conexion, $idPlanificacionAnual, 'revisado');
				}
