...
class SitiosModelo extends ModeloBase 
{
		...
		* Campo requerido
		* Campo visible en el formulario
		* Tipo de sitio registrado por el técnico.
		*/
		protected $tipoSitio;
		/**
		* @var String
		* Campo requerido
		* Campo visible en el formulario
		* Campo que indica si se supervisó la ubicación del sitio
		*/
		protected $supervisarUbicacion;
		/**
		* @var String
		* Campo requerido
		* Campo visible en el formulario
		* Campo que almacena la observación de la actualización de la ubicación del sitio
		*/
...
*/
	...
	*Tipo de sitio registrado por el técnico.
	*
	* @parámetro String $tipoSitio
	* @return TipoSitio
	*/
	public function setTipoSitio($tipoSitio)
	{
	  $this->tipoSitio = (String) $tipoSitio;
	    return $this;
	}
	...
	*/
	...
	/**
	* Set supervisarUbicacion
	*
	*Campo que indica si se supervisó la ubicación del sitio
	*
	* @parámetro String $supervisarUbicacion
	* @return SupervisarUbicacion
	*/
	public function setSupervisarUbicacion($supervisarUbicacion)
	{
	  $this->supervisarUbicacion = (String) $supervisarUbicacion;
	    return $this;
	}

	/**
	* Get supervisarUbicacion
	*
	* @return null|String
	*/
	public function getSupervisarUbicacion()
	{
		return $this->supervisarUbicacion;
	}
