...
while($usuario = pg_fetch_assoc($usuarios)){
    echo '<tr id="' . $usuario['identificador'] . '" class="item" data-rutaAplicacion="uath" data-opcion="generarValoracionPerfil" ondragstart="drag(event)" draggable="true" data-destino="detalleItem">
        <td>'.($contador++).'</td>
