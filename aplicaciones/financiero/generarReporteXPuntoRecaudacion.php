<?php 
	...
	header("Content-Disposition: attachment; filename=REPORTEXPUNTORECAUDACION.xls");
	...
	$res = $cc -> filtrarRecaudacionPorPuntoEmision($conexion, $comprobante, $fechaInicio, $fechaFin, $establecimiento, $ruc, $valor=1);
