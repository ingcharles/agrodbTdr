<?php
/**
 * Modelo EvaluacionPrimariaModelo
 *
 * Este archivo se complementa con el archivo EvaluacionPrimariaLogicaNegocio.
 *
 * @author AGROCALIDAD
 * @date    2020-03-16
 * @uses EvaluacionPrimariaModelo
...
class EvaluacionPrimariaModelo extends ModeloBase{

	/**
	 *
	 * @var Integer Campo requerido
	 *      Campo visible en el formulario
	 *      Llave primaria de la tabla evaluacion_primaria
	 */
	...
	/**
	 * Nombre de la tabla: evaluacion_primaria
	 */
	private $tabla = "evaluacion_primaria";

	/**
	 * Clave primaria
	 */
	private $clavePrimaria = "id_evaluacion_primaria";

	/**
	 * Secuencia
	 */
	private $secuencial = 'g_historias_clinicas"."evaluacion_primaria_id_evaluacion_primaria_seq';
	...
	public function __set($name, $value){
		...
		if (! method_exists($this, $method)){
			throw new \Exception('Clase Modelo: EvaluacionPrimariaModelo. Propiedad especificada invalida: set' . $name);
		}
		$this->$method($value);
	}
	...
	public function __get($name){
		$method = 'get' . $name;
		if (! method_exists($this, $method)){
			throw new \Exception('Clase Modelo: EvaluacionPrimariaModelo. Propiedad especificada invalida: get' . $name);
		}
		return $this->$method();
	}
