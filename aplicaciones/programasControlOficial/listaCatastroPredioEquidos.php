...
<header>
	<h1>Censo de Predios de Équidos</h1>
	<nav>
		<form id="listaCatastroPredioEquidos" data-rutaAplicacion="programasControlOficial" data-opcion="listaCatastroPredioEquidosFiltrada" data-destino="tabla">
			<table class="filtro">
				<tr>
					<th>Código Sitio:</th>
					<td>
...
<script>
	...
	$("#listaCatastroPredioEquidos").submit(function(e){
		abrir($(this),e,false);
	});
