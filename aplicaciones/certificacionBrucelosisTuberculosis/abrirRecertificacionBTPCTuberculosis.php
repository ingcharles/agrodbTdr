...
<div class="pestania">
	...
	<form id="cerrarCertificacionBT" data-rutaAplicacion="<?php echo $ruta;?>" data-opcion="guardarCierreRecertificacionBTPC" data-destino="detalleItem" data-accionEnExito="ACTUALIZAR">
...
var perfil= <?php echo json_encode($perfilAdmin); ?>;
	...
	$("#cerrarCertificacionBT").submit(function(event){
		...
		$("#cerrarCertificacionBT").attr('data-opcion', 'guardarCierreRecertificacionBTPC');
