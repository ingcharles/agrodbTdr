...
header("Content-Disposition: attachment; filename=reporteMatrizPACTemporal.xls");
...
<div id="tablaHeader">
	<table id="tablaReportePac" class="soloImpresion">
		<thead>
			...
			<tr>
			    <td colspan="5" id="textoTitulo">REFORMA No. <?php //ingresar número de reforma?></td>
			</tr>
...
<div id="tablaHeader">
	<table id="tablaReportePacFirmas" class="soloImpresion">
		...
		<?php 
			//Realizado por
			$idRealizadoGA = $_SESSION['usuario'];
			$nombreRealizadoGA = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $idRealizadoGA));

			//Revisado por
			$idRevisadoGA = pg_fetch_result($ca->buscarResponsableSubproceso($conexion,'GA' ), 0, 'identificador');
			$nombreRevisadoGA = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $idRevisadoGA));
			
			//Aprobado por
			$idAprobadoDGAF = pg_fetch_result($ca->buscarResponsableSubproceso($conexion,'DGAF' ), 0, 'identificador');
			$nombreAprobadoGA = pg_fetch_assoc($cu->obtenerNombresUsuario($conexion, $idAprobadoDGAF));
		?>
		<tbody>
			 <tr>
				 <td colspan="5" id="textoSubtituloFirmas"><?php echo $nombreRealizadoGA['nombre'].' '.$nombreRealizadoGA['apellido'];?></td>
				 <td colspan="5" id="textoSubtituloFirmas"><?php echo $nombreRevisadoGA['nombre'].' '.$nombreRevisadoGA['apellido'];?></td>
				 <td colspan="5" id="textoSubtituloFirmas"><?php echo $nombreAprobadoGA['nombre'].' '.$nombreAprobadoGA['apellido'];?></td>
			 </tr>
			 
			 <tr>
				 <td colspan="5" id="textoSubtituloFirmas">ANALISTA ADMINISTRATIVO</td>
				 <td colspan="5" id="textoSubtituloFirmas">RESPONSABLE DEL ÁREA ADMINISTRATIVA</td>
				 <td colspan="5" id="textoSubtituloFirmas">DIRECTORA ADMINISTRATIVA FINANCIERA</td>
			 </tr>
			 
			 <tr>
				 <td colspan="5" id="textoSubtituloFirmas">REALIZADO</td>
				 <td colspan="5" id="textoSubtituloFirmas">REVISADO</td>
				 <td colspan="5" id="textoSubtituloFirmas">APROBADO</td>
			 </tr>
		</tbody>
	</table>
</div>
