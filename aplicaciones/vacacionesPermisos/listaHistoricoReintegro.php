<?php 
	...
	$tipoPermiso = $_POST['tipoSolicitudFil'];
	$subtipoPermiso = $_POST['subtipoPermiso'];
	$estadoVacacion = $_POST['estadoVacacion'];
	$area = $_POST['area'];
		
	$listaReporte = $cv->filtroObtenerReporteHistoricoUsuario($conexion, $identificador, $apellido, $nombre, $fechaInicio, $fechaFin, $tipoPermiso, $subtipoPermiso, $estadoVacacion, $area,'no');
...
<tr>
	<td class="botonesTabla">
		<form id="generarReporteExcel" action="aplicaciones/vacacionesPermisos/generarReporteHistoricoReintegroExcel.php" target="_blank" method="post">
	...
	<td>
		<form id="generarReportePDF" data-rutaAplicacion="vacacionesPermisos"	data-opcion="generarReporteHistoricoReintegroPDF" data-destino="detalleItem">
...
<?php 
		...
		while($fila = pg_fetch_assoc($listaReporte)){
			...
			echo '<tr 
						...
						data-opcion="abrirPermisoReintegroHistorico" 
