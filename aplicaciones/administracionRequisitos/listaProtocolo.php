...
<body>
	...
	switch ($opcion){
		case 'subTipoProducto':
			$res = $cp->listarProtocoloComercio($conexion,	$tipoProducto,'tipoProducto');
		break;
		
		case 'producto':
			$res = $cp->listarProtocoloComercio($conexion,$subTipoProducto, 'subTipoProducto');
		break;
		
		default:
			$res = $cp->listarProtocoloComercio($conexion,$producto, 'producto');
	}
		...
		while($fila = pg_fetch_assoc($res)){
			...
			$contenido = '<article 
						...
						data-opcion="abrirProductoPaisProtocolo" 
