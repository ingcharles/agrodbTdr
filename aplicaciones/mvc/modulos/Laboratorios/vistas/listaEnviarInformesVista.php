...
<?php echo $this->codigoJS; ?>
    ...
    function buscarClientes() {
        if ($("#id_laboratorios_provincia").val() !== "") {
            ...
            $.post("<?php echo URL ?>Laboratorios/BandejaResponsableTecnico/buscarClientesFirma",
                    {
    ...
    function fn_filtrar() {
        ...
        $("#paginacion").html("<div id='cargando'>Cargando...</div>");
        $.post("<?php echo URL ?>Laboratorios/ArchivoInformeAnalisis/enviarInformes/",
                {
                    id_laboratorios_provincia: $("#id_laboratorios_provincia").val(),
    ...
    function fn_enviar_informe(idAInforme) {
        var elementoDestino = "#detalleItem";
        var url = "<?php echo URL ?>Laboratorios/ArchivoInformeAnalisis/enviarInforme";
        var data = {
