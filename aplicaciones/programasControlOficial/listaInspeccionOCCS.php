...
<header>
	<h1>Censo de Ovinos, Caprinos y Camélidos Sudamericanos</h1>
	<nav>
		<form id="listaInspeccionOCCS" data-rutaAplicacion="programasControlOficial" data-opcion="listaInspeccionOCCSFiltrada" data-destino="tabla">
			<table class="filtro">
				<tr>
...
<script>
	...
	$("#listaInspeccionOCCS").submit(function(e){
		abrir($(this),e,false);
	});
