...
<header>
	<h1>Reporte de Mantenimientos Generados</h1>
	<nav>
		<form id="filtrar" data-rutaAplicacion="transportes" data-opcion="reportes" data-destino="detalleItem" action="aplicaciones/transportes/reporteMantenimientosGeneradosDetalle.php" target="_blank" method="post"> 
