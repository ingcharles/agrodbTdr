...
$res = $so->listaManejoMaterialesPeligrosos($conexion, $_POST['laboratorio'],quitar_tildes($_POST['nombreProducto']), $_POST['numeroUn'], $_POST['numeroCas'],'');
...
<header>
	<h1>Buscar Material Peligroso</h1>
	
	<nav>
	<form id="nuevoBuscarMaterialPeligroso" data-rutaAplicacion="seguridadOcupacional" data-opcion="listaManejoMaterialPeligroso" data-destino="areaTrabajo #listadoItems">
