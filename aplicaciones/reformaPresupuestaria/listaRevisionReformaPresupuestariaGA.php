...
<header>
	<h1>Revisión Reforma Presupuestaria</h1>
	...
	<nav style="width: 78%;">
		<form id="filtrarPlanificacionAnual" data-rutaAplicacion="reformaPresupuestaria" data-opcion="listaReformaPresupuestariaFiltradaGA" data-destino="contenedor">
...
var usuario = <?php echo json_encode($usuario); ?>;
	...
	$("#filtrarPlanificacionAnual").submit(function(event){
		$("#filtrarPlanificacionAnual").attr('data-opcion', 'listaReformaPresupuestariaFiltradaGA');
