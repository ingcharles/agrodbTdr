<?php
/**
 * Modelo AdjuntosHistoriaClinicaModelo
 *
 * Este archivo se complementa con el archivo AdjuntosHistoriaClinicaLogicaNegocio.
 *
 * @author AGROCALIDAD
 * @date    2020-03-16
 * @uses AdjuntosHistoriaClinicaModelo
...
class AdjuntosHistoriaClinicaModelo extends ModeloBase{
	...
	/**
	 * Nombre de la tabla: adjuntos_historia_clinica
	 */
	private $tabla = "adjuntos_historia_clinica";

	/**
	 * Clave primaria
	 */
	private $clavePrimaria = "id_adjuntos_historia_clinica";

	/**
	 * Secuencia
	 */
	private $secuencial = 'g_historias_clinicas"."adjuntos_historia_clinica_id_adjuntos_historia_clinica_seq';
	...
	public function __set($name, $value){
		...
		if (! method_exists($this, $method)){
			throw new \Exception('Clase Modelo: AdjuntosHistoriaClinicaModelo. Propiedad especificada invalida: set' . $name);
		}
		$this->$method($value);
	}
	...
	public function __get($name){
		$method = 'get' . $name;
		if (! method_exists($this, $method)){
			throw new \Exception('Clase Modelo: AdjuntosHistoriaClinicaModelo. Propiedad especificada invalida: get' . $name);
		}
		return $this->$method();
	}
	...
	/**
	 * Set idAdjuntosHistoriaClinica
	 *
	 * Llave primaria de la tabla
	 *
	 * @parámetro Integer $idAdjuntosHistoriaClinica
	 * @return IdAdjuntosHistoriaClinica
	 */
