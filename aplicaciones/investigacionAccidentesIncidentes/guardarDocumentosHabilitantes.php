...
try {
	...
	$cai->guardarDocumentosHabilitantes($conexion,$datos['solicitud'],$cedulaPapeleta,$cedulaPapeletaRep,$infoReporte,
			$datos['responPatron']);
	
	///----------------finalizar solicitud----------------------------------------------------------------
	$cai->actualizarRegistroSso($conexion,$datos['solicitud'],'Pendiente de Aprobar','',3);
