 ...
 * Modelo RangosModelo
 *
 * Este archivo se complementa con el archivo RangosLogicaNegocio.
 *
 * @author AGROCALIDAD
 * @date    2022-02-18
 * @uses RangosModelo
...
class RangosModelo extends ModeloBase{
	 ...
	 * @var Integer Campo requerido
	 *      Campo visible en el formulario
	 *      Clave foranea de la tabla metodos
	 */
	protected $idMetodo;
	...
	/**
	 * Nombre de la tabla: rangos
	 */
	private $tabla = "rangos";

	/**
	 * Clave primaria
	 */
	private $clavePrimaria = "id_rango";

	/**
	 * Secuencia
	 */
	private $secuencial = 'g_catalogos"."rangos_id_rango_seq';
	...
	public function __set($name, $value){
		...
		if (! method_exists($this, $method)){
			throw new \Exception('Clase Modelo: RangosModelo. Propiedad especificada invalida: set' . $name);
		}
		$this->$method($value);
	}
	...
	public function __get($name){
		$method = 'get' . $name;
		if (! method_exists($this, $method)){
			throw new \Exception('Clase Modelo: RangosModelo. Propiedad especificada invalida: get' . $name);
		}
		return $this->$method();
	}
	 ...
	 * Identificador unico de la tabla
	 *
	 * @parámetro Integer $idRango
	 * @return IdRango
	 */
	public function setIdRango($idRango){
		$this->idRango = (integer) $idRango;
		return $this;
	}
