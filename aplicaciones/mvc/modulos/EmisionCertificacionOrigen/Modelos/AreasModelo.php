...
class AreasModelo extends ModeloBase 
{
		...
		* Campo requerido
		* Campo visible en el formulario
		* Columna en la cual se almacena código especifico de transacción (Para banano: código mag)
		*/
		protected $codigoTransaccional;
...
*/
	...
	*Secuencia
*/
		 private $secuencial1 = 'g_operadores"."areas_id_area_seq'; 
	...
	*/
	...
	{
	  $this->secuencial = (String) $secuencial;
	    return $this;
	}
	...
	*/
	...
	/**
	* Set codigoTransaccional
	*
	*Columna en la cual se almacena código especifico de transacción (Para banano: código mag)
	*
	* @parámetro String $codigoTransaccional
	* @return CodigoTransaccional
	*/
	public function setCodigoTransaccional($codigoTransaccional)
	{
	  $this->codigoTransaccional = (String) $codigoTransaccional;
	    return $this;
	}

	/**
	* Get codigoTransaccional
	*
	* @return null|String
	*/
	public function getCodigoTransaccional()
	{
		return $this->codigoTransaccional;
	}
