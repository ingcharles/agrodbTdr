...
<header>
	...
	<nav>
		<form id="filtrar" data-rutaAplicacion="reformaPresupuestaria" data-opcion="guardarNuevaPlanificacionAnual" data-destino="detalleItem" action="aplicaciones/reformaPresupuestaria/reporteMatrizPacTemporalDetalle.php" target="_blank" method="post"> 
