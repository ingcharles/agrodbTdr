...
<header>
	<h1>Notificaciones de Eventos Sanitarios</h1>
	<nav>
		<form id="NotificacionEventosSanitarios" data-rutaAplicacion="seguimientoEventosSanitarios" data-opcion="NotificacionEventosSanitarios" data-destino="detalleItem" action="aplicaciones/seguimientoEventosSanitarios/reporteNotificacionEventosSanitariosDetalle.php" target="_blank" method="post">
			<table class="filtro">
				<tr>
