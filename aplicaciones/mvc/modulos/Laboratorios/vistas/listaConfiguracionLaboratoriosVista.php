...
<header>
    <h1>Formularios Laboratorios</h1>
...
<?php echo $this->codigoJS; ?>
        ...
        function fn_llenarCmbLaboratorioFiltro() {
            ...
            if ($("#fDireccion").val() !== "") {
                ...
                $.post("<?php echo URL ?>Laboratorios/Laboratorios/comboLaboratorios/" + $("#fDireccion").val(), function (data) {
    ...
    function fn_actualizarDnD(id, idPadreNuevo) {
        $.post("<?php echo URL ?>Laboratorios/Laboratorios/editarDnD/",
                {
                    idLaboratorio: id,
                    fkIdLaboratorio: idPadreNuevo
                },
        function (data) {
            idExpandir = id;
        });
    ...
    function fn_filtrar() {
        ...
        $.post("<?php echo URL ?>Laboratorios/Laboratorios/parametrosConfLab/",
                {
    ...
    function fn_abrirVistaAgregar(id) {
        ...
        var url = "<?php echo URL ?>Laboratorios/Laboratorios/agregarCampos";
        var data = {
            id: "_nuevo",
            idPadre: id
        };
     ...
     * @returns {undefined}
     */
    function  cambiarOrden(campo, idLaboratorio) {

        $.post("<?php echo URL ?>Laboratorios/Laboratorios/cambiarOrden",
                {
     ...
     /**
     * Cambia el orden de los campos de la orden de trabajo
     * @param {type} campo
     * @param {type} idInforme
     * @returns {undefined}
     */
    function  cambiarOrden_ot(campo, idLaboratorio) {
     ...
     * @returns {undefined}
     */
    function  cambiarEstado(campo, idLaboratorio) {
        ...
        $.post("<?php echo URL ?>Laboratorios/Laboratorios/cambiarEstado",
                {
                    id_laboratorio: idLaboratorio,
