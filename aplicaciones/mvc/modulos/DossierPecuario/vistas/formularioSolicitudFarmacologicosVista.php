...
<div class="pestania">
    ...
    <form id='formularioPaso5' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='solicitud/guardar' data-destino="detalleItem" method="post">
    	...
    	<fieldset>
    		<legend>Especificaciones y características del producto, cuando corresponda</legend>
    		
    		<div data-linea="17">
    			<label for="ph">pH: </label>
    			<input type="text" id="ph" name="ph" value="<?php echo $this->modeloSolicitud->getPh(); ?>" maxlength="256" class="formulario" />
    		</div>				

    		<div data-linea="18">
    			<label for="viscosidad">Viscosidad: </label>
    			<input type="text" id="viscosidad" name="viscosidad" value="<?php echo $this->modeloSolicitud->getViscosidad(); ?>" maxlength="256" class="formulario" />
    		</div>				
    
    		<div data-linea="19">
    			<label for="densidad">Densidad: </label>
    			<input type="text" id="densidad" name="densidad" value="<?php echo $this->modeloSolicitud->getDensidad(); ?>" maxlength="256" class="formulario" />
    		</div>			
    	...
    	<fieldset>
    		<legend>Métodos de Control y Evaluación</legend>
    		
    		<div data-linea="20">
    			<label for="metodo_biologico">Métodos biológicos: </label>
    			<input type="text" id="metodo_biologico" name="metodo_biologico" value="<?php echo $this->modeloSolicitud->getMetodoBiologico(); ?>" maxlength="512"  class="formulario" />
    		</div>				
    
    		<div data-linea="21">
    			<label for="metodo_microbiologico">Métodos microbiológicos: </label>
    			<input type="text" id="metodo_microbiologico" name="metodo_microbiologico" value="<?php echo $this->modeloSolicitud->getMetodoMicrobiologico(); ?>" maxlength="512"  class="formulario" />
    		</div>				
    
    		<div data-linea="8">
    			<label for="metodo_fis_quim">Método físico-químico: </label>
    			<input type="text" id="metodo_fis_quim" name="metodo_fis_quim" value="<?php echo $this->modeloSolicitud->getMetodoFisQuim(); ?>" maxlength="512" class="formulario" />
    		</div>			
    	</fieldset>	
...
<div class="pestania">
    ...
    <form id='formularioPaso6' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='solicitud/guardar' data-destino="detalleItem" method="post">
    	...
    	<fieldset>
    		<legend>Agente Etiológico</legend>
    		
    		<div data-linea="17">
    			<label for="agente_etiologico">Agente etiológico susceptible (aplicable para antibióticos y antiparasitarios): </label>
    		</div>
    		
    		<div data-linea="18">
    			<input type="text" id="agente_etiologico" name="agente_etiologico" value="<?php echo $this->modeloSolicitud->getAgenteEtiologico(); ?>" maxlength="1024" class="formulario" />
    		</div>				
    ...
    <form id='formularioPreparacion' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='solicitud/guardar' data-destino="detalleItem" method="post">
    	...
    	<fieldset>
    		...
    		<div data-linea="4">
    			...
    			<input type="text" id="farmacocinetica" name="farmacocinetica" value="<?php echo $this->modeloSolicitud->getFarmacocinetica(); ?>" maxlength="1024" class="formulario" />
    		</div>				
    
    		<div data-linea="5">
    			<label for="farmacodinamica">Farmacodinámica: </label>
    			<input type="text" id="farmacodinamica" name="farmacodinamica" value="<?php echo $this->modeloSolicitud->getFarmacodinamica(); ?>" maxlength="1024" class="formulario" />
    		</div>
    		...
    		<p class="nota">Declarar la siguiente información cuando corresponda:</p>
    		...
    		<div data-linea="9">
    			...
    			<select id="id_categoria_toxicologica" name="id_categoria_toxicologica" class="formulario" >
                    <option value="">Seleccionar....</option>
                    <?php
                        echo $this->comboCategoriaToxicologica('IAV');
                    ?>
                </select>
            </div>
            
    		<div data-linea="10" class="editable">
    			<button type="submit" class="guardar">Guardar</button>
    		</div>
...
<div class="pestania">
	<form id='formularioPeriodoRetiro' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='PeriodoRetiro/guardar' data-destino="detalleItem" method="post" class="editable">
    	<input type="hidden" id="id_solicitud" name="id_solicitud" value="<?php echo $this->modeloSolicitud->getIdSolicitud(); ?>" />
    	...
    	<fieldset>
    		...
    		<div data-linea="1">
    			<label for="id_especie">Especie: </label>
    			<select id="id_especie_periodo_retiro" name="id_especie" >
                    <option value="">Seleccionar....</option>
                    <?php
                        echo $this->comboEspecies();
                    ?>
    		...
    		<div data-linea="2">
    			<label for="nombre_especie_retiro">Nombre especie: </label>
    			<input type="text" id="nombre_especie_retiro" name="nombre_especie" maxlength="128" />
    		</div>				
    		...
    		<div data-linea="5">
    			...
    			<select id="id_unidad_tiempo_retiro" name="id_unidad_tiempo">
                    <option value="">Seleccionar....</option>
                    <?php
                        echo $this->comboUnidadTiempoXId();
                    ?>
    			...
    			<input type="hidden" id="nombre_unidad_tiempo_retiro" name="nombre_unidad_tiempo" maxlength="32" />
    		</div>				
    ...
    <div id="tablaPeriodoRetiro">
        <fieldset>
        	<legend>Período de Retiro</legend>
            	<div data-linea="3">
        			<table id="tbItemsPeriodoRetiro" style="width:100%">
        				<thead>
        					<tr>
        						<th style="width: 5%;">#</th>
        						<th style="width: 20%;">Especie</th>
        						<th style="width: 25%;">Nombre especie</th>
        						<th style="width: 25%;">Producto de consumo</th>
        						<th style="width: 20%;">Tiempo de retiro</th>
                                <th style="width: 5%;"></th>
        					</tr>
        				</thead>
        				<tbody>
	...
	<form id='formularioPeriodoVidaUtil' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='PeriodoVidaUtil/guardar' data-destino="detalleItem" method="post" class="editable">
    	...
    	<fieldset>
    		...
    		<div data-linea="6">
    			<label for="id_unidad_tiempo_vida_util">Tiempo: </label>
    ...
    <form id='formularioConservacion' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='solicitud/guardar' data-destino="detalleItem" method="post">
    	...
    	<fieldset>
    		...
    		<div data-linea="48">
    			<label for="control_residuos">Control sobre residuos de medicamentos: </label>
    			<input type="text" id="control_residuos" name="control_residuos" value="<?php echo $this->modeloSolicitud->getControlResiduos(); ?>" maxlength="1024" class="formulario" />
    		</div>	
...
var combo = "<option>Seleccione....</option>";
  ...
  //Para origen de producto grid
    ...
    $("#formularioPaso5").submit(function (event) {
		...
		if($.trim($("#viscosidad").val())){
			if(!esCampoValido("#viscosidad")){
            	error = true;
            	$("#viscosidad").addClass("alertaCombo");
			}
		}

		if($.trim($("#densidad").val())){
			if(!esCampoValido("#densidad")){
            	error = true;
            	$("#densidad").addClass("alertaCombo");
			}
		}

		if($.trim($("#metodo_biologico").val())){
			if(!esCampoValido("#metodo_biologico")){
            	error = true;
            	$("#metodo_biologico").addClass("alertaCombo");
			}
		}

		if($.trim($("#metodo_microbiologico").val())){
			if(!esCampoValido("#metodo_microbiologico")){
            	error = true;
            	$("#metodo_microbiologico").addClass("alertaCombo");
			}
		}

		if($.trim($("#metodo_fis_quim").val())){
			if(!esCampoValido("#metodo_fis_quim")){
            	error = true;
            	$("#metodo_fis_quim").addClass("alertaCombo");
			}
		}
    ...
    $("#formularioPaso6").submit(function (event) {
		...
		if($.trim($("#agente_etiologico").val())){
			if(!esCampoValido("#agente_etiologico")){
            	error = true;
            	$("#agente_etiologico").addClass("alertaCombo");
			}
		}
    ...
    $("#formularioPreparacion").submit(function (event) {
		...
		if($.trim($("#farmacocinetica").val())){
			if(!esCampoValido("#farmacocinetica")){
            	error = true;
            	$("#farmacocinetica").addClass("alertaCombo");
			}
		}

		if($.trim($("#farmacodinamica").val())){
			if(!esCampoValido("#farmacodinamica")){
            	error = true;
            	$("#farmacodinamica").addClass("alertaCombo");
			}
		}
    ...
    $("#formularioPeriodoRetiro").submit(function (event) {
		fn_limpiar();
		event.preventDefault();
		var error = false;
		
		if(!$.trim($("#id_especie_periodo_retiro").val())){
        	error = true;
        	$("#id_especie_periodo_retiro").addClass("alertaCombo");
		}
		...
		if (!error) {
	        var respuesta = JSON.parse(ejecutarJson($(this)).responseText);
	       	if (respuesta.estado == 'exito'){
	       		fn_mostrarDetallePeriodoRetiro();
	       		fn_limpiarPeriodoRetiroCompleto();
	        }else{
	        	fn_mostrarDetallePeriodoRetiro();
	        }
		} else {
    ...
    //Para cargar el detalle de Período de retiro
    function fn_mostrarDetallePeriodoRetiro() {
        var idSolicitud = $("#id_solicitud").val();
        
    	$.post("<?php echo URL ?>DossierPecuario/PeriodoRetiro/construirDetallePeriodoRetiro/",
    	{
			idSolicitud : idSolicitud,
			fase : bandera
		}, function (data) {
            $("#tbItemsPeriodoRetiro tbody").html(data);
        });
    }

  	//Funcion que elimina una fila de la lista 
    function fn_eliminarDetallePeriodoRetiro(idDetallePeriodoRetiro) { 
        $.post("<?php echo URL ?>DossierPecuario/PeriodoRetiro/borrar",
        {                
            elementos: idDetallePeriodoRetiro
        },
        function (data) {
        	fn_mostrarDetallePeriodoRetiro();
        });
    ...
    function fn_limpiarPeriodoRetiroCompleto() {
    	$("#id_especie_periodo_retiro").val("");
    	$("#nombre_especie_retiro").val("");
    ...
    $("#formularioConservacion").submit(function (event) {
		...
		if($.trim($("#control_residuos").val())){
			if(!esCampoValido("#control_residuos")){
            	error = true;
            	$("#control_residuos").addClass("alertaCombo");
			}
		}
