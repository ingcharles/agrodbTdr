<?php
 /**
 * Modelo Vigilanciaf01Modelo
 *
 * Este archivo se complementa con el archivo   Vigilanciaf01LogicaNegocio.
 *
 * @author  AGROCALIDAD
 * @date    2021/08/23
 * @uses    Vigilanciaf01Modelo
...
class Vigilanciaf01Modelo extends ModeloBase 
{
	...
	* 
	...
	/**
	* Nombre de la tabla: vigilanciaf01
	* 
	 */
	Private $tabla="vigilanciaf01";
...
*/
	...
	*Secuencia
*/
		 private $secuencial = 'f_inspeccion"."Vigilanciaf01_id_seq'; 
	...
	*/
	...
	{
		throw new \Exception('Clase Modelo: Vigilanciaf01Modelo. Propiedad especificada invalida: set'.$name);
	}
	$this->$method($value);
	}
	...
	*/
	...
	if (!method_exists($this, $method))
	{
	  throw new \Exception('Clase Modelo: Vigilanciaf01Modelo. Propiedad especificada invalida: get'.$name);
	}
	return $this->$method();
	}
	...
	*
	*
	* @parámetro String $estadoVf01
	* @return EstadoVf01
	*/
	public function setEstadoVf01($estadoVf01)
	{
	  $this->estadoVf01 = (String) $estadoVf01;
	    return $this;
	}
	...
	* @return null|String
	*/
	public function getEstadoVf01()
	{
		return $this->estadoVf01;
	}
	...
	*
	*
	* @parámetro String $observacionVf01
	* @return ObservacionVf01
	*/
	public function setObservacionVf01($observacionVf01)
	{
	  $this->observacionVf01 = (String) $observacionVf01;
	    return $this;
	}
	...
	* @return null|String
	*/
	public function getObservacionVf01()
	{
		return $this->observacionVf01;
	}
