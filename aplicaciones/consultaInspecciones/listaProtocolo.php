...
<h1>Protocolos</h1>
	<nav>
		<form action="aplicaciones/consultaInspecciones/reporteImprimirProtocolo.php" method="post">
			...
			<table class="filtro" style='width:100%;'>
				<tbody>
					...
					<tr>
						<td align="left">Tipo de Protocolo:</td>
						<td colspan="3">
							<select id="tipoProtocolo" name="tipoProtocolo" required style='width:99%;'>
