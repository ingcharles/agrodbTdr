...
<body>
	...
	<div id="estado"></div>
	<form id="regresar" data-rutaAplicacion="registroProducto" data-opcion="abrirTipoProducto" data-destino="detalleItem">
	...
	<table class="soloImpresion">
		<tr>
			<td>
				...
				<form id="nuevoProducto" data-rutaAplicacion="registroProducto" data-opcion="guardarNuevoProducto" >
					...
					<fieldset>
						...
						<div data-linea="3">
							...
							<input name="numeroRegistro" id="numeroRegistro" type="text" required="required" />
						</div>
						...
						<div id="div6" data-linea="6">
								...
								<input type="text" id="txtClienteBusqueda" name="txtClienteBusqueda" maxlength="13" required="required"/>							
						</div>
						<div id="res_cliente" data-linea="7"></div>
											
						<div data-linea="8">
							<label for="observaciones">Observaciones/Modificaciones:</label>
							<input name="observaciones" id="observaciones" type="text" required="required" />
						</div>
				...
				<fieldset>
						...
						<div data-linea="3">
							<label>Categoría toxicológica</label> 
								<select id="caToxicologica" name="caToxicologica" required>
						...
						<div data-linea="3">
							...
							<input id="periodoReingreso" name="periodoReingreso" required="required" />
					...
					<table id="productos">
						<?php 
							while ($producto = pg_fetch_assoc($productos)){
								echo $cr->imprimirLineaProducto($producto['id_producto'], $producto['nombre_comun'], $idSubtipoProducto, $areaSubProducto, 'registroProducto');
							}
						?>
					</table>
				</fieldset>
