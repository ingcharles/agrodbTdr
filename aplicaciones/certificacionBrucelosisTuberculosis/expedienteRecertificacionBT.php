...
<header>
	<h1>Expediente de Recertificación de Predios Libres de Brucelosis y Tuberculosis</h1>
	<nav>
		<form id="listaRecertificacionBT" data-rutaAplicacion="certificacionBrucelosisTuberculosis" data-opcion="expedienteRecertificacionBTDetalle" data-destino="detalleItem" action="aplicaciones/certificacionBrucelosisTuberculosis/expedienteRecertificacionBTDetalle.php" target="_blank" method="post">
