<?php
/**
 * Modelo ExamenParaclinicosModelo
 *
 * Este archivo se complementa con el archivo ExamenParaclinicosLogicaNegocio.
 *
 * @author AGROCALIDAD
 * @date    2020-03-16
 * @uses ExamenParaclinicosModelo
...
class ExamenParaclinicosModelo extends ModeloBase{
	...
	/**
	 * Nombre de la tabla: examen_paraclinicos
	 */
	private $tabla = "examen_paraclinicos";

	/**
	 * Clave primaria
	 */
	private $clavePrimaria = "id_examen_paraclinicos";

	/**
	 * Secuencia
	 */
	private $secuencial = 'g_historias_clinicas"."examen_paraclinicos_id_examen_paraclinicos_seq';
	...
	public function __set($name, $value){
		...
		if (! method_exists($this, $method)){
			throw new \Exception('Clase Modelo: ExamenParaclinicosModelo. Propiedad especificada invalida: set' . $name);
		}
		$this->$method($value);
	}
	...
	public function __get($name){
		$method = 'get' . $name;
		if (! method_exists($this, $method)){
			throw new \Exception('Clase Modelo: ExamenParaclinicosModelo. Propiedad especificada invalida: get' . $name);
		}
		return $this->$method();
	}
