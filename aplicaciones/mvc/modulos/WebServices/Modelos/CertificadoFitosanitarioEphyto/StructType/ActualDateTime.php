...
/**
 * This class stands for actualDateTime StructType
 * @subpackage Structs
 */
class ActualDateTime extends AbstractStructBase
{
    /**
     * The DateTimeString
    ...
    /**
     * Constructor method for actualDateTime
     * @uses ActualDateTime::setDateTimeString()
     ...
     * @param string $dateTimeString
     * @return \StructType\ActualDateTime
     */
