...
<form id='formulario'
	data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>SeguimientoDocumental' data-opcion='tramites/cargarTramiteMasivoCiudadano' data-destino="detalleItem" method="post">

	<fieldset>
		<legend>Carga masiva para trámites ingresados por Ciudadanos</legend>
		...
		<div data-linea="1">
			...
			<button type="button" class="subirArchivo adjunto" data-rutaCarga="aplicaciones/mvc/modulos/SeguimientoDocumental/archivos/tramites">Subir archivo</button>
		</div>
...
$('button.subirArchivo').click(function (event) {
	var nombre_archivo = "<?php echo 'tramite' . (md5(time())); ?>";
        var boton = $(this);
