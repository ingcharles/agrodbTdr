	...
	<form id="formularioSitioArea" data-rutaAplicacion="<?php echo URL_MVC_FOLDER;?>AdministrarOperaciones" data-opcion="AdministrarOperaciones/guardarSitioArea" data-destino="detalleItem" method="post">
	    ...
	    <fieldset>
            ...
            <div data-linea="6">
           		...
           		<select id="parroquiaF" name="parroquiaF">
            ...
            <div data-linea="7">
           		...
           		<input type="text" name="direccion" id="direccion" value="<?php echo $this->datosSitios->current()->direccion; ?>" required="required" data-er="^[A-Za-zñÑÁáÉéÍíÓóÚúÜü.#-/°0-9 ]+$" maxlength="256" >
           	</div>
           	
            <div data-linea="8">
           		<label>Referencia: </label>
           		<input type="text" name="referencia" id="referencia" value="<?php echo $this->datosSitios->current()->referencia; ?>" required="required" data-er="^[A-Za-zñÑÁáÉéÍíÓóÚúÜü.#-/°0-9 ]+$" maxlength="1024" >
           	</div>
           	
           	<div data-linea="9">
           		<label>Latitud: </label>
           		<input type="text" name="latitud" id="latitud" value="<?php echo $this->datosSitios->current()->latitud; ?>" required="required" data-er="^[0-9]+(\.[0-9]{1,})?$" maxlength="128" >
           	</div>
           	
            <div data-linea="9">
           		<label>Longitud: </label>
           		<input type="text" name="longitud" id="longitud" value="<?php echo $this->datosSitios->current()->longitud; ?>" required="required" data-er="^[0-9]+(\.[0-9]{1,})?$" maxlength="128" >
           	</div>
           	
           	<div data-linea="10">
           		<label>Zona: </label>
           		<input type="text" name="zona" id="zona" value="<?php echo $this->datosSitios->current()->zona; ?>" required="required" data-er="^[0-9]+(\.[0-9]{1,})?$" maxlength="128" >
           	</div>
           	
           	<div data-linea="10">
           		<label>Superficie total: </label>
           		<input type="text" name="superficie_total" id="superficie_total" value="<?php echo $this->datosSitios->current()->superficie_total; ?>" required="required" data-er="^[0-9]+(\.[0-9]{1,2})?$" >
           	</div>
