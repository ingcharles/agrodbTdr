...
<form id="enviarAprobacionDGAF" data-rutaAplicacion="programacionAnualPresupuestaria" data-opcion="enviarAprobacionDGAF" data-accionEnExito="ACTUALIZAR" >
	<input type='hidden' id='identificador' name='identificador' value="<?php echo $identificador;?>" />
	
	<p>La siguiente <b>Planificación Anual</b> será enviada para la aprobación de <b>Presupuestos</b> en la Dirección General Administrativa Financiera: </p>
	...
	<?php
		for ($i = 0; $i < count ($elementosPlanificacionAnual); $i++) {
			...
			if($planificacionAnual['estado'] == 'revisadoAprobador'){
				echo'<fieldset>
...
var array_planificacion_anual= <?php echo json_encode($elementosPlanificacionAnual); ?>;
	...
	$("#enviarAprobacionDGAF").submit(function(event){
