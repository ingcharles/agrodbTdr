...
/**
 * This class stands for intendedUse StructType
 * @subpackage Structs
 */
class IntendedUse extends AbstractStructBase
{
    /**
     * The active
    ...
    public $name;
    /**
     * Constructor method for intendedUse
     * @uses IntendedUse::setActive()
     * @uses IntendedUse::setCode()
     * @uses IntendedUse::setLang()
     * @uses IntendedUse::setLastModified()
     * @uses IntendedUse::setLastModifiedBy()
     * @uses IntendedUse::setName()
     * @param bool $active
     * @param string $code
     * @param string $lang
