...
<fieldset>
	...
	<div data-linea="2">
		<textarea rows="4" id="justificacion" readonly="readonly" name="justificacion" class="desabilitado"><?php echo $capacitacion['justificacion']?></textarea>
	</div>
</fieldset>
...
<fieldset>
	...
	<div data-linea="3">
		<textarea rows="3" id="observacion" name="observacion" readonly="readonly" class="desabilitado"><?php echo $capacitacion['observacion']?></textarea>
	</div>   
	<div data-linea="4">
		<label>Observación talento humano</label>
	</div>
	<div data-linea="5">
		<textarea rows="3" id="observacionTH" name="observacionTH" readonly="readonly"><?php echo $capacitacion['observacion_talento_humano']?></textarea>
	</div>
...
<fieldset>
	...
	<div data-linea="5">
		<label>Informe generado</label> <?php echo ($capacitacion['ruta_informe']==''? '<span class="alerta">No se ha generado el informe</span>':'<a href='.$capacitacion['ruta_informe'].' target="_blank" class="archivo_cargado" id="archivo_cargado">Informe de Capacitación Generado</a>')?>
    </div>   
</fieldset>
