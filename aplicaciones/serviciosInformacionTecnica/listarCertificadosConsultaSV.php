...
<?php 		
$registros = $controladorInformacion->listarCertificadosXPais($conexion,$_POST['pais']);
?>
...
<header>
		...
		<nav>
		<form id="filtrar" data-rutaAplicacion="serviciosInformacionTecnica" data-opcion="listarCertificadosConsultaSV" data-destino="areaTrabajo #listadoItems">
...
<header>		
	...
	while($fila = pg_fetch_assoc($registros)){		
		...
		$contenido = '<article
						...
						data-opcion="abrirCertificadoConsultaSV"
