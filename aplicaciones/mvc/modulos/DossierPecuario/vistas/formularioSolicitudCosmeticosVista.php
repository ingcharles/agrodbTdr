...
<div class="pestania">
	<form id='formularioFormaFisFarCosProducto' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='FormaFisFarCosProducto/guardar' data-destino="detalleItem" method="post" class="editable">
    	...
    	<fieldset>
    		<legend>Forma Cosmética/Farmacéutica</legend>				
    
    		<div data-linea="1">
    			<label for="id_forma">Forma cosmética/farmacéutica: </label>
            	...
            	<div data-linea="3">
        			<table id="tbItemsFormaFisFarCosProducto" style="width:100%">
        				<thead>
        					<tr>
        						<th style="width: 10%;">#</th>
        						<th style="width: 80%;">Forma Cosmética/Farmacéutica</th>
                                <th style="width: 10%;"></th>
        					</tr>
        				</thead>
        				<tbody>
    ...
    <form id='formularioPaso5' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='solicitud/guardar' data-destino="detalleItem" method="post">
    	...
    	<fieldset>
    		...
    		<div data-linea="20">
    			<label for="metodo_biologico">Métodos biológicos (Aplica para cosméticos): </label>
...
<div class="pestania">
    ...
    <form id='formularioPaso6' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='solicitud/guardar' data-destino="detalleItem" method="post">
    	...
    	<fieldset>
    		...
    		<div data-linea="17">
    			<label for="agente_etiologico">Agente etiológico susceptible (aplicable para antisépticos, desinfectantes, sanitizantes y plaguicidas): </label>
    		</div>
    ...
    <form id='formularioFormaAdministracion' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='FormaAdministracion/guardar' data-destino="detalleItem" method="post" class="editable">
    	<input type="hidden" id="id_solicitud" name="id_solicitud" value="<?php echo $this->modeloSolicitud->getIdSolicitud(); ?>" />
    	
    	<fieldset>
    		<legend>Forma de Aplicación en Animales</legend>				
    
    		<div data-linea="1">
    			<label for="id_especie_destino">Especie de destino: </label>
    			<select id="id_especie_destino" name="id_especie_destino" >
                    <option value="">Seleccionar....</option>
                    <?php
                        echo $this->comboEspecies();
                    ?>
    		...
    		<div data-linea="2">
    			<label for="nombre_especie_administracion">Nombre especie: </label>
    			<input type="text" id="nombre_especie_administracion" name="nombre_especie" maxlength="128" />
    		</div>				
    		...
    		<div data-linea="4">
    			...
    			<input type="text" id="cantidad_producto" name="cantidad_producto" maxlength="256" />
    		</div>
    ...
    <div id="tablaFormaAdministracion">
        <fieldset>
        	<legend>Forma de Aplicación en animales</legend>
            	<div data-linea="3">
        			<table id="tbItemsFormaAdministracion" style="width:100%">
        				<thead>
        					<tr>
        						<th style="width: 5%;">#</th>
        						<th style="width: 20%;">Especie de destino</th>
        						<th style="width: 20%;">Nombre especie</th>
        						<th style="width: 30%;">Características del animal</th>
        						<th style="width: 20%;">Cantidad del producto</th>
                                <th style="width: 5%;"></th>
        					</tr>
        				</thead>
        				<tbody>
   ...
   <form id='formularioFormaAplicacionInstalaciones' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='FormaAplicacionInstalaciones/guardar' data-destino="detalleItem" method="post" class="editable">
    	<input type="hidden" id="id_solicitud" name="id_solicitud" value="<?php echo $this->modeloSolicitud->getIdSolicitud(); ?>" />
    	
    	<fieldset>
    		<legend>Forma de Aplicación en instalaciones, superficies y medios de transporte de animales</legend>				
    
    		<div data-linea="1">
    			<label for="dosis_instalacion">Dosis: </label>
    			<input type="text" id="dosis_instalacion" name="dosis" maxlength="128" />
    		</div>				
    
    		<div data-linea="2">
    			<label for="forma_administracion_instalacion">Forma de administración: </label>
    			<input type="text" id="forma_administracion_instalacion" name="forma_administracion" maxlength="256" />
    		</div>
 	...
 	<div id="tablaFormaAplicacionInstalaciones">
        <fieldset>
        	<legend>Forma de Aplicación en Instalaciones</legend>
            	<div data-linea="3">
        			<table id="tbItemsFormaAplicacionInstalaciones" style="width:100%">
        				<thead>
        					<tr>
        						<th style="width: 5%;">#</th>
        						<th style="width: 45%;">Dosis</th>
        						<th style="width: 45%;">Forma de aplicación</th>
                                <th style="width: 5%;"></th>
        					</tr>
        				</thead>
        				<tbody>
...
<div class="pestania">
    <form id='formularioPreparacion' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='solicitud/guardar' data-destino="detalleItem" method="post">
    	...
    	<fieldset>
    		<legend>Preparación y contraindicaciones</legend>
    		...
    		<div data-linea="6">
    			<label for="efectos_colaterales">Efectos colaterales, locales, incompatibles, antagonismos y contraindicaciones: </label>
    		</div>
    		...
    		<p class="nota">Para plaguicidas de uso veterinario declarar la siguiente información cuando corresponda:</p>
    ...
    <form id='formularioConservacion' data-rutaAplicacion='<?php echo URL_MVC_FOLDER; ?>DossierPecuario' data-opcion='solicitud/guardar' data-destino="detalleItem" method="post">
    	...
    	<fieldset>
    		...
    		<div data-linea="5">
    			...
    			<input type="text" id="condiciones_almacenamiento_abierto" name="condiciones_almacenamiento_abierto" value="<?php echo $this->modeloSolicitud->getRecomendacionConservacion(); ?>" maxlength="128" class="formulario" />
    		</div>		
...
var combo = "<option>Seleccione....</option>";
	...
	$(document).ready(function() {
		...
		fn_mostrarDetalleFormaAdministracion();
		fn_mostrarDetalleFormaAplicacionInstalaciones();

		//***PASO 7
		$(".detallePreparacion").hide();
		fn_mostrarDetalleEfectoBiologico();
		cargarValorDefecto("id_categoria_toxicologica","<?php echo $this->modeloSolicitud->getIdCategoriaToxicologica();?>");
  ...
  //Para origen de producto grid
    ...
    $("#formularioFormaAdministracion").submit(function (event) {
		fn_limpiar();
		event.preventDefault();
		var error = false;
		...
		if (!error) {
	        var respuesta = JSON.parse(ejecutarJson($(this)).responseText);
	       	if (respuesta.estado == 'exito'){
	       		fn_mostrarDetalleFormaAdministracion();
	       		fn_limpiarFormaAdministracionCompleto();
	        }else{
	        	fn_mostrarDetalleFormaAdministracion();
	        }
		} else {
    ...
    //Para cargar el detalle de Forma de Administración
    function fn_mostrarDetalleFormaAdministracion() {
        var idSolicitud = $("#id_solicitud").val();
        
    	$.post("<?php echo URL ?>DossierPecuario/FormaAdministracion/construirDetalleFormaAdministracion/",
    	{
			idSolicitud : idSolicitud,
			fase : bandera
		}, function (data) {
            $("#tbItemsFormaAdministracion tbody").html(data);
        });
    }

  	//Funcion que elimina una fila de la lista 
    function fn_eliminarDetalleFormaAdministracion(idDetalleFormaAdministracion) { 
        $.post("<?php echo URL ?>DossierPecuario/FormaAdministracion/borrar",
        {                
            elementos: idDetalleFormaAdministracion
        },
        function (data) {
        	fn_mostrarDetalleFormaAdministracion();
        });
    ...
    function fn_limpiarFormaAdministracionCompleto() {
    	$("#id_especie_destino").val("");
    	$("#nombre_especie_administracion").val("");
    	$("#caracteristicas_animal").val("");
    	$("#cantidad_producto").val("");
    }

    $("#formularioFormaAplicacionInstalaciones").submit(function (event) {
		fn_limpiar();
		event.preventDefault();
		var error = false;
		
		if(!$.trim($("#dosis_instalacion").val())){
        	error = true;
        	$("#dosis_alimento_instalacion").addClass("alertaCombo");
		}
		
		if(!$.trim($("#forma_administracion_instalacion").val())){
        	error = true;
        	$("#forma_administracion_instalacion").addClass("alertaCombo");
		}
		...
		if (!error) {
	        var respuesta = JSON.parse(ejecutarJson($(this)).responseText);
	       	if (respuesta.estado == 'exito'){
	       		fn_mostrarDetalleFormaAplicacionInstalaciones();
	       		fn_limpiarFormaAplicacionInstalacionesCompleto();
	        }else{
	        	fn_mostrarDetalleFormaAplicacionInstalaciones();
	        }
		} else {
    ...
    //Para cargar el detalle de Forma de Aplicación en Instalaciones
    function fn_mostrarDetalleFormaAplicacionInstalaciones() {
        var idSolicitud = $("#id_solicitud").val();
        
    	$.post("<?php echo URL ?>DossierPecuario/FormaAplicacionInstalaciones/construirDetalleFormaAplicacionInstalaciones/",
    	{
			idSolicitud : idSolicitud,
			fase : bandera
		}, function (data) {
            $("#tbItemsFormaAplicacionInstalaciones tbody").html(data);
        });
    }

  	//Funcion que elimina una fila de la lista 
    function fn_eliminarDetalleFormaAplicacionInstalaciones(idDetalleFormaAplicacionInstalaciones) { 
        $.post("<?php echo URL ?>DossierPecuario/FormaAplicacionInstalaciones/borrar",
        {                
            elementos: idDetalleFormaAplicacionInstalaciones
        },
        function (data) {
        	fn_mostrarDetalleFormaAplicacionInstalaciones();
        });
    ...
    function fn_limpiarFormaAplicacionInstalacionesCompleto() {
    	$("#dosis_instalacion").val("");
    	$("#forma_administracion_instalacion").val("");
    }
    ...
    $("#formularioPeriodoRetiro").submit(function (event) {
		...
		if(!$.trim($("#nombre_especie_retiro").val())){
        	error = true;
        	$("#nombre_especie_retiro").addClass("alertaCombo");
		}
