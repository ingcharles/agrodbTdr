...
<header>
	<h1>Reporte de Combustibles Generados</h1>
	<nav>
		<form id="filtrar" data-rutaAplicacion="transportes" data-opcion="reportes" data-destino="detalleItem" action="aplicaciones/transportes/reporteCombustiblesGeneradosDetalle.php" target="_blank" method="post"> 
