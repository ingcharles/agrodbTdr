...
<header>
	...
	$res = $ced->listaEvaluaciones($conexion, 'RESULTADOS');
	...
	while($fila = pg_fetch_assoc($res)){
		echo '<article
						...
						data-opcion="generarResultadoEvaluacion"
...
<script>
	...
	$("#_valoresCumplimiento").click(function(){
		if($("#cantidadItemsSeleccionados").text()>1){
				alert('Por favor seleccione una evaluación a la vez');
				return false;
			}
		});
</script>