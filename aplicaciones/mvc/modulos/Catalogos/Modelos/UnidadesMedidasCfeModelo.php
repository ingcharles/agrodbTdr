<?php
 /**
 * Modelo UnidadesMedidasCfeModelo
 *
 * Este archivo se complementa con el archivo   UnidadesMedidasCfeLogicaNegocio.
 *
 * @author  AGROCALIDAD
 * @date    2022-09-10
 * @uses    UnidadesMedidasCfeModelo
 * @package Catalogos
 * @subpackage Modelos
 */
...
class UnidadesMedidasCfeModelo extends ModeloBase 
{
	...
	* 
	...
	/**
	* Nombre de la tabla: unidades_medidas_cfe
	* 
	 */
	Private $tabla="unidades_medidas_cfe";
...
*/
	...
	*Secuencia
*/
		 private $secuencial = 'g_catalogos"."UnidadesMedidasCfe_id_unidad_medida_seq'; 
	...
	*/
	...
	{
		throw new \Exception('Clase Modelo: UnidadesMedidasCfeModelo. Propiedad especificada invalida: set'.$name);
	}
	$this->$method($value);
	}
	...
	*/
	...
	if (!method_exists($this, $method))
	{
	  throw new \Exception('Clase Modelo: UnidadesMedidasCfeModelo. Propiedad especificada invalida: get'.$name);
	}
	return $this->$method();
	}
	...
	*Código correspondiente para el envió a hub proceso Ephyto
	*
	* @parámetro String $codigoHub
	* @return CodigoHub
	*/
	public function setCodigoHub($codigoHub)
	{
	  $this->codigoHub = (String) $codigoHub;
	    return $this;
	}
