<?php 
	...
	echo '<input type="hidden" id="' . pg_fetch_result($idTipoProducto, 0, 'id_tipo_producto') . '" data-rutaAplicacion="registroProducto" data-opcion="abrirTipoProductoPlaguicida" data-destino="detalleItem"/>'
?>
