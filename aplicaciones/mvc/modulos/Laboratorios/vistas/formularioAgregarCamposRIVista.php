...
<form id = 'formulario' data-rutaAplicacion = '<?php echo URL_MVC_FOLDER; ?>Laboratorios'
    ...
    <fieldset>			
        ...
        <input type ="hidden" name="id_direccion" id="id_direccion" value ="<?php echo $this->modeloCamposResultadosInformes->getIdDireccion() ?>">
        <input type ="hidden" name="id_laboratorio" id="id_laboratorio" value ="<?php echo $this->modeloCamposResultadosInformes->getIdLaboratorio() ?>">     
        <input type ="hidden" name="id_servicio" id="id_servicio" value ="<?php echo $this->modeloCamposResultadosInformes->getIdServicio() ?>"> 
        <input type ="hidden" name="fk_id_campos_resultados_inf" id="fk_id_campos_resultados_inf" value ="<?php echo $this->modeloCamposResultadosInformes->getFkIdCamposResultadosInf() ?>">    
...
<?php echo $this->codigoJS ?>
        ...
        function fn_cargarServicios() {
            ...
            if (idLaboratorio !== "") {
                ...
                $.post("<?php echo URL ?>Laboratorios/CamposResultadosInformes/buscarServiciosPadre/" + idLaboratorio, function (data) {
                    $('#id_servicio').combotree({
                        data: data,
                        editable: true,
                        onClick: function (node) {
                            fn_cargarCampos(node.id);
                        }
                    });
                }, 'json');
            }
