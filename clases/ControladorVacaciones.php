...
class ControladorVacaciones{
	...
	public function nuevoPermiso($conexion,$subTipoSolicitud,$fechaSalida,$fechaRetorno,$horaSalida,$horaRetorno,$identificador,$minutos_utilizados,
			$fecha_maxima_justificar,$rutaArchivo,$periodosTomados,$fechaSuceso, $idAreaPermiso, $destinoComision,$pivTipo){
...
//------------------------------------------------------------------------------------------------------------	
	...
	public function actualizarPermiso($conexion,$id_registro,$subTipoSolicitud,$fechaSalida,$fechaRetorno,$identificador,
	    $minutos_utilizados,$fecha_maxima_justificar,$rutaArchivo,$fechaSuceso, $idAreaPermiso, $destinoComision,$pivTipo){
		$fechaSalida = $fechaSalida!="" ? "'" . $fechaSalida . "'" : "null";
		$fechaRetorno = $fechaRetorno!="" ? "'" . $fechaRetorno . "'" : "null";
		$fechaSuceso = $fechaSuceso!="" ? "'" . $fechaSuceso . "'" : "null";
		$fecha_maxima_justificar = $fecha_maxima_justificar!="" ? "'" . $fecha_maxima_justificar . "'" : "null";
...
//-------------------------------------------------------------------------------------------------------
public function nuevoPermisoDescuento($conexion,$subTipoSolicitud,$fechaSalida,$fechaRetorno,$horaSalida,$horaRetorno,$identificador,$minutos_utilizados,
		$fecha_maxima_justificar,$rutaArchivo,$periodosTomados,$fechaSuceso, $idAreaPermiso, $destinoComision,$pivTipo){
...
public function nuevoEncargado($conexion,$identificador_responsable,$identificador_encargado,$id_area,$id_area_encargado,
		$nombrePuesto,$nombrePuestoEncargado,$fechaInicio,$fechaFin,$idPermiso,$designacion,$archivoSub){
