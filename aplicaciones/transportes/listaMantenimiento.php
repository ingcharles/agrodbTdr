...
<header>
	...
	$res = $cv->listarMantenimiento($conexion,$_SESSION['nombreLocalizacion'],'ABIERTOS','MANTENIMIENTOS');
	$contador = 0;
	while($fila = pg_fetch_assoc($res)){
		echo '<article
						...
						data-opcion="abrirMantenimiento"
					...
					<span>'.$fila['placa'].' - '.$fila['kilometraje'].' kms<br/></span>
