	...
	try{
		...
		try {
			...
			if(($identificador != null) || ($identificador != '')){
				...
				$patologiaTuberculosis = $cbt->buscarPatologiaTuberculosisCertificacionBT($conexion, $idCertificacionBT, $numInspeccion);
		
				if(pg_num_rows($patologiaTuberculosis) == 0){
					$conexion->ejecutarConsulta("begin;");
					
					$idPatologiaTuberculosis = pg_fetch_result($cbt->guardarPatologiaTuberculosisCertificacionBT($conexion, 
																		...
																		0, 'id_certificacion_bt_patologia_tuberculosis');				
					
					$mensaje['estado'] = 'exito';
					$mensaje['mensaje'] = $cbt->imprimirLineaPatologiaTuberculosisCertificacionBT($idPatologiaTuberculosis, 
