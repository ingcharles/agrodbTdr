<?php
/**
 * Modelo ElementoProteccionModelo
 *
 * Este archivo se complementa con el archivo ElementoProteccionLogicaNegocio.
 *
 * @author AGROCALIDAD
 * @date    2020-03-16
 * @uses ElementoProteccionModelo
...
class ElementoProteccionModelo extends ModeloBase{
	 ...
	 */
	protected $idElementoProteccion;
	...
	/**
	 * Nombre de la tabla: elemento_proteccion
	 */
	private $tabla = "elemento_proteccion";

	/**
	 * Clave primaria
	 */
	private $clavePrimaria = "id_elemento_proteccion";

	/**
	 * Secuencia
	 */
	private $secuencial = '"ElementoProteccion_"id_elemento_proteccion_seq';
	...
	public function __set($name, $value){
		...
		if (! method_exists($this, $method)){
			throw new \Exception('Clase Modelo: ElementoProteccionModelo. Propiedad especificada invalida: set' . $name);
		}
		$this->$method($value);
	}
	...
	public function __get($name){
		$method = 'get' . $name;
		if (! method_exists($this, $method)){
			throw new \Exception('Clase Modelo: ElementoProteccionModelo. Propiedad especificada invalida: get' . $name);
		}
		return $this->$method();
	}
	...
	/**
	 * Set idElementoProteccion
	 *
	 * Llave primaria de la tabla
	 *
	 * @parámetro Integer $idElementoProteccion
	 * @return IdElementoProteccion
	 */
	public function setIdElementoProteccion($idElementoProteccion){
		$this->idElementoProteccion = (integer) $idElementoProteccion;
		return $this;
	}

	/**
	 * Get idElementoProteccion
	 *
	 * @return null|Integer
	 */
	public function getIdElementoProteccion(){
		return $this->idElementoProteccion;
	}
