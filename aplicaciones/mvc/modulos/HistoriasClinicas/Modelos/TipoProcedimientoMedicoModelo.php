<?php
/**
 * Modelo TipoProcedimientoMedicoModelo
 *
 * Este archivo se complementa con el archivo TipoProcedimientoMedicoLogicaNegocio.
 *
 * @author AGROCALIDAD
 * @date    2020-03-16
 * @uses TipoProcedimientoMedicoModelo
...
class TipoProcedimientoMedicoModelo extends ModeloBase{
	...
	/**
	 * Nombre de la tabla: tipo_procedimiento_medico
	 */
	private $tabla = "tipo_procedimiento_medico";

	/**
	 * Clave primaria
	 */
	private $clavePrimaria = "id_tipo_procedimiento_medico";

	/**
	 * Secuencia
	 */
	private $secuencial = '"TipoProcedimientoMedico_"id_tipo_procedimiento_medico_seq';
	...
	public function __set($name, $value){
		...
		if (! method_exists($this, $method)){
			throw new \Exception('Clase Modelo: TipoProcedimientoMedicoModelo. Propiedad especificada invalida: set' . $name);
		}
		$this->$method($value);
	}
	...
	public function __get($name){
		$method = 'get' . $name;
		if (! method_exists($this, $method)){
			throw new \Exception('Clase Modelo: TipoProcedimientoMedicoModelo. Propiedad especificada invalida: get' . $name);
		}
		return $this->$method();
	}
