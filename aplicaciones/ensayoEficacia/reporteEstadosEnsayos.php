...
$ext   = '.xls';
$nomReporte = 'estados_EE_'.$fecha.$ext;
...
$queryReporte = $ce-> obtenerRegistrosEnsayos($conexion);
...
<body>
	<div id="header">
		...
		<div id="textoEncabezado" style="font-size: 16px; font-weight: bold;">
			...
			<br>AGROCALIDAD
         <br>REPORTE DE ESTADOS DE SOLICITUDES DE ENSAYOS DE EFICACIA
		</div>
