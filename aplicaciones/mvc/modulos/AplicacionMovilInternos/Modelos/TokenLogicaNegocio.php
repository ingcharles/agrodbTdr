...
use Agrodb\Core\Token\JwtVerify;
use Agrodb\Core\Token\JwtGenerate;
...
class TokenLogicaNegocio
{
    ...
    public function auth()
    {
        ...
        $token = $jwtGenerate->generateToken();
        $statusCode = 200;
        return array(
     ...
     */
    public function devolverDatosQueryToken($resultado, $tipo)
    {
    ...
    {
        return password_hash(PRIVATE_KEY, PASSWORD_DEFAULT, ['cost' => 13]);
    }
     ...
     * @return bool	
     */
    public function validarPublicKey($hash)
    {
        return password_verify(PRIVATE_KEY, $hash);
    }
}
