...
_33(e,"mousedown");
if($.fn.draggable1.isDragging||$.fn.resizable.isResizing){
e.preventDefault();
}
};
function _34(e){
...
(function($){
function _39(e){
var _3a=$.data(e.data.target,"draggable1");
var _3b=_3a.options;
var _3c=_3a.proxy;
var _3d=e.data;
...
function _3f(e){
var _40=$.data(e.data.target,"draggable1");
var _41=_40.options;
var _42=_40.proxy;
if(!_42){
_42=$(e.data.target);
...
function _43(e){
if(!$.fn.draggable1.isDragging){
return false;
}
var _44=$.data(e.data.target,"draggable1");
var _45=_44.options;
var _46=$(".droppable1:visible").filter(function(){
return e.data.target!=this;
}).filter(function(){
var _47=$.data(this,"droppable1").options.accept;
if(_47){
...
var _4a=$.data(e.data.target,"draggable1");
_39(e);
...
var _4c=$(this);
if(_4c.droppable1("options").disabled){
return;
}
var p2=_4c.offset();
...
_49(e);
var _4f=$.data(e.data.target,"draggable1");
var _50=_4f.proxy;
var _51=_4f.options;
...
var _56=$(this);
if(_56.droppable1("options").disabled){
return;
}
var p2=_56.offset();
...
function _4e(){
if($.fn.draggable1.timer){
clearTimeout($.fn.draggable1.timer);
$.fn.draggable1.timer=undefined;
}
$(document).unbind(".draggable1");
$.fn.draggable1.isDragging=false;
setTimeout(function(){
$("body").css("cursor","");
},100);
};
$.fn.draggable1=function(_57,_58){
if(typeof _57=="string"){
return $.fn.draggable1.methods[_57](this,_58);
}
return this.each(function(){
var _59;
var _5a=$.data(this,"draggable1");
if(_5a){
_5a.handle.unbind(".draggable1");
_59=$.extend(_5a.options,_57);
}else{
_59=$.extend({},$.fn.draggable1.defaults,$.fn.draggable1.parseOptions(this),_57||{});
}
var _5b=_59.handle?(typeof _59.handle=="string"?$(_59.handle,this):_59.handle):$(this);
$.data(this,"draggable1",{options:_59,handle:_5b});
if(_59.disabled){
$(this).css("cursor","");
return;
}
_5b.unbind(".draggable1").bind("mousemove.draggable1",{target:this},function(e){
if($.fn.draggable1.isDragging){
return;
}
var _5c=$.data(e.data.target,"draggable1").options;
if(_5d(e)){
$(this).css("cursor",_5c.cursor);
}else{
$(this).css("cursor","");
}
}).bind("mouseleave.draggable1",{target:this},function(e){
$(this).css("cursor","");
}).bind("mousedown.draggable1",{target:this},function(e){
if(_5d(e)==false){
return;
}
$(this).css("cursor","");
...
$.extend(e.data,_60);
var _61=$.data(e.data.target,"draggable1").options;
if(_61.onBeforeDrag.call(e.data.target,e)==false){
return;
}
$(document).bind("mousedown.draggable1",e.data,_43);
$(document).bind("mousemove.draggable1",e.data,_49);
$(document).bind("mouseup.draggable1",e.data,_4d);
$.fn.draggable1.timer=setTimeout(function(){
$.fn.draggable1.isDragging=true;
_43(e);
},_61.delay);
return false;
});
function _5d(e){
var _62=$.data(e.data.target,"draggable1");
var _63=_62.handle;
var _64=$(_63).offset();
...
$.fn.draggable1.methods={options:function(jq){
return $.data(jq[0],"draggable1").options;
},proxy:function(jq){
return $.data(jq[0],"draggable1").proxy;
},enable:function(jq){
return jq.each(function(){
$(this).draggable1({disabled:false});
});
},disable:function(jq){
return jq.each(function(){
$(this).draggable1({disabled:true});
});
}};
$.fn.draggable1.parseOptions=function(_67){
var t=$(_67);
return $.extend({},$.parser.parseOptions(_67,["cursor","handle","axis",{"revert":"boolean","deltaX":"number","deltaY":"number","edge":"number","delay":"number"}]),{disabled:(t.attr("disabled")?true:undefined)});
};
$.fn.draggable1.defaults={proxy:null,revert:false,cursor:"move",deltaX:null,deltaY:null,handle:null,disabled:false,edge:0,axis:null,delay:100,onBeforeDrag:function(e){
...
(function($){
function _68(_69){
$(_69).addClass("droppable1");
$(_69).bind("_dragenter",function(e,_6a){
$.data(_69,"droppable1").options.onDragEnter.apply(_69,[e,_6a]);
});
$(_69).bind("_dragleave",function(e,_6b){
$.data(_69,"droppable1").options.onDragLeave.apply(_69,[e,_6b]);
});
$(_69).bind("_dragover",function(e,_6c){
$.data(_69,"droppable1").options.onDragOver.apply(_69,[e,_6c]);
});
$(_69).bind("_drop",function(e,_6d){
$.data(_69,"droppable1").options.onDrop.apply(_69,[e,_6d]);
});
};
$.fn.droppable1=function(_6e,_6f){
if(typeof _6e=="string"){
return $.fn.droppable1.methods[_6e](this,_6f);
}
_6e=_6e||{};
return this.each(function(){
var _70=$.data(this,"droppable1");
if(_70){
$.extend(_70.options,_6e);
}else{
_68(this);
$.data(this,"droppable1",{options:$.extend({},$.fn.droppable1.defaults,$.fn.droppable1.parseOptions(this),_6e)});
}
});
};
$.fn.droppable1.methods={options:function(jq){
return $.data(jq[0],"droppable1").options;
},enable:function(jq){
return jq.each(function(){
$(this).droppable1({disabled:false});
});
},disable:function(jq){
return jq.each(function(){
$(this).droppable1({disabled:true});
});
}};
$.fn.droppable1.parseOptions=function(_71){
var t=$(_71);
return $.extend({},$.parser.parseOptions(_71,["accept"]),{disabled:(t.attr("disabled")?true:undefined)});
};
$.fn.droppable1.defaults={accept:null,disabled:false,onDragEnter:function(e,_72){
...
_f2.disabledNodes=[];
_f3.dnd=true;
_f4.find("div.tree-node").draggable1({disabled:false,revert:true,cursor:"pointer",proxy:function(_f5){
...
$(this).droppable1("disable");
_f2.disabledNodes.push(this);
});
$(this).draggable1("proxy").css({left:-10000,top:-10000});
...
if(d>3){
$(this).draggable1("proxy").show();
}
this.pageY=e.pageY;
},onStopDrag:function(){
for(var i=0;i<_f2.disabledNodes.length;i++){
$(_f2.disabledNodes[i]).droppable1("enable");
}
_f2.disabledNodes=[];
...
}}).droppable1({accept:"div.tree-node",onDragEnter:function(e,_f9){
...
if($(this).droppable1("options").disabled){
return;
}
var _fd=_fc.pageY;
...
var icon=$(_106).draggable1("proxy").find("span.tree-dnd-icon");
...
_29e.window.draggable1({handle:">div.panel-header>div.panel-title",disabled:_29e.options.draggable1==false,onBeforeDrag:function(e){
if(_29e.mask){
...
return $.extend({},$.fn.panel.parseOptions(_2ac),$.parser.parseOptions(_2ac,[{draggable1:"boolean",resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,draggable1:true,resizable:true,shadow:true,modal:false,border:true,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false,constrain:false});
})(jQuery);
(function($){
function _2ad(_2ae){
...
function _2c7(_2c8){
var opts=$.extend({},$.messager.defaults,{modal:false,shadow:false,draggable1:false,resizable:false,closed:true,style:{left:"",top:"",right:0,zIndex:$.fn.window.defaults.zIndex++,bottom:-document.body.scrollTop-document.documentElement.scrollTop},title:"",width:250,height:100,minHeight:0,showType:"slide",showSpeed:600,content:_2c8.msg,timeout:4000},_2c8);
...
_bfa.find("a.slider-handle").draggable1({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
