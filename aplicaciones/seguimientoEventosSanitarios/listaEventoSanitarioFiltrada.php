	...
	while($fila = pg_fetch_assoc($EventoSanitario)){
		...
		echo '<article 
			...
			if($fila['estado']=='Creado'){
				echo 'data-opcion="abrirEventoSanitario"';
			}else if($fila['estado']=='primeraVisita'){
				echo 'data-opcion="abrirEventoSanitarioPrimeraVisita"';
			}else if($fila['estado']=='visita'){
				echo 'data-opcion="abrirEventoSanitarioVisitas"';
			}else if($fila['estado']=='visitaCierre'){
				echo 'data-opcion="abrirEventoSanitarioVisitaCierre"';
