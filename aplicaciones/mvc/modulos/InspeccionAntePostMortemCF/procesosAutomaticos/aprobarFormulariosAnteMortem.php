...
define('ROOT', '/var/www/html/SVNguia/aplicaciones/'); //***definir ruta de la aplicacion***
...
$app = new Router('InspeccionAntePostMortemCF','formularioAnteMortem','procesoAutomatico');
