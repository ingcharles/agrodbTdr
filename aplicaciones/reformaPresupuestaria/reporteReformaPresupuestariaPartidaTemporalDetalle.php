...
<div id="header">
	...
	<form id="filtrar" action="reporteReformaPresupuestariaPartidaTemporalDetalleExcel.php" target="_blank" method="post">
	 ...
	 <input type="hidden" id="nombreAreaN2" name="nombreAreaN2" value="<?php echo $_POST['nombreAreaN2'];?>" />
	 <input type="hidden" id="programasReporte" name="programasReporte" value="<?php echo $_POST['programasReporte'];?>" />
	 ...
	 <input type="hidden" id="proyectoReporte" name="proyectoReporte" value="<?php echo $_POST['proyectoReporte'];?>" />
	 <input type="hidden" id="idProyectoPAC" name="idProyectoPAC" value="<?php echo $_POST['idProyectoPAC'];?>" />
	 <input type="hidden" id="codigoProyectoPAC" name="codigoProyectoPAC" value="<?php echo $_POST['codigoProyectoPAC'];?>" />
	 <input type="hidden" id="nombreProyecto" name="nombreProyecto" value="<?php echo $_POST['nombreProyecto'];?>" />
	 <input type="hidden" id="actividadReporte" name="actividadReporte" value="<?php echo $_POST['actividadReporte'];?>" />
	 <input type="hidden" id="idActividadPAC" name="idActividadPAC" value="<?php echo $_POST['idActividadPAC'];?>" />
	 <input type="hidden" id="codigoActividadPAC" name="codigoActividadPAC" value="<?php echo $_POST['codigoActividadPAC'];?>" />
	 <input type="hidden" id="nombreActividadPAC" name="nombreActividadPAC" value="<?php echo $_POST['nombreActividadPAC'];?>" />
	 <input type="hidden" id="estadoReporte" name="estadoReporte" value="<?php echo $_POST['estadoReporte'];?>" />
